...
public class HPGSubscriber implements Comparable<HPGSubscriber> {
    ...
    private String buildDateColumn(String data) {
        ...
        Period period =
                Period.between(
                        today.toLocalDate(), purgeDate.toLocalDate()); // How long until the purge
        String dayOrDays = period.getDays() > 1 ? "days" : "day";
        StringBuilder sb = new StringBuilder("<td><div class='date'>");
        sb.append(data);
        sb.append(
                "</div><div class='yellow'><image src='images/yellow.png' title='This entry will be removed from the tracker in ");
        sb.append(period.getDays());
        sb.append(" ");
        sb.append(dayOrDays);
        sb.append("'></div>");
        sb.append(
                "<div class='red'><image src='images/red.png' title='This entry will be removed from the tracker in ");
        sb.append(period.getDays());
        sb.append(" ");
        sb.append(dayOrDays);
        sb.append("'></div></td>");
