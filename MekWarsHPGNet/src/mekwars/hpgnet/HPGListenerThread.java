...
/**
 * HPGListenerThread listens for connections from MekWars servers, makes the connections and hands
 * them off to HPGProcessingThreads to deal with
 *
 * @author Spork
 * @author Torren
 * @author urgru
    ...
    public synchronized void run() {
        ...
        try {
            ...
            while (true) { // always listen for calls
                ...
                hpgnet.addToLog(
                        "lthread: connection accepted from "
                                + sock.getInetAddress()
                                + ", being processing.");
