...
public class IOUtil {
    ...
    /**
     * Gets the CRC32 value from the given InputStream. Note that the input stream should be
     * pointing at the beginning when it is passed in (i.e. nothing should have been read from it
     * yet) and it will be closed after the call completes.
     *
    ...
    /**
     * Deletes deep and all of its parent directories up to base. Behavior is undefined if base is
     * not a parent of deep ; )
     */
    ...
    /**
     * Add all of the files and directories inside of dir to list. Normally you just want to use
     * getTree(File) instead.
     */
    ...
    /**
     * Breaks the jar file name away from the embedded file in an URL or filename. The individual
     * parts (without the '!') come back in a String array. Example:
     * parseJarURL("xithdemo/cosm.jar!/com/navtools/util/IOUtil.class") yields new String[] {
     * "xithdemo/cosm.jar", "/com/navtools/util/IOUtil.class"}
     *
