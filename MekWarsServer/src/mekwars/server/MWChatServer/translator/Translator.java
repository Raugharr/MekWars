...
/**
 * This class "translates" things by using a specially formatted varibles that can be substituted. A
 * properties file, which is really just key/value pairs, might look something like this:
 *
 * <pre>
 ...
 *
 * <p>Given the properties file above, this call:
 *
 * <pre>getMessage("invited", "jack", "jack's room");</pre>
 *
 * Would return
 *
 * <pre>Jack has invited you to jack's room</pre>
 *
 * The "translation" part is actually a manual step, in that somebody has to actually create a
 * translated version of the properties file(s).
 */
public class Translator {
    ...
    /**
     * The most general case of substituting variables: {0} thru {n} are substibuted with args[0]
     * thru args[n].
     */
