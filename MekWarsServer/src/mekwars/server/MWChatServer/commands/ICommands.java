...
/**
 * This class describes the protocol between the server and the client. Contained in here are a
 * whole bunch of constants that represent commands going over the wire. A command consists of
 * string arguments separated by DELIMITER. The recipient of a command determines what the command
 * is by looking at the first argument. The first argument will be a string from this class (at
 * least for the core set of commands).
 *
 * <p>There are two helper classes for creating valid commands (one server, one client).
 *
 * <p><b>Note:</b> Consult the protocol documentation instead of this class. It's messy in here.
 *
...
public interface ICommands {
    ...
    /**
     * if you understand this you are a 1.1-compliant client. Following DEFLATED + DELIMITER is the
     * number of bytes in the undeflated text. This will be a maximum of 29999, so you don't have to
     * buffer more than that. com.carnageblender.chat.net gives an example implemenation.
     */
     ...
     *
     * <p>args: a specific command (optional) acknowledgement: plain text
     */
     ...
     * Version
     *
     * <p>Tell the server about what version of the client this is. This can be a freeform string.
     * The first space-delmited token should be the protocol version implemented: 1.0 = basic; 1.1 =
     * basic + deflate. The default implementation sends "NFC Classic. Java version <vendor> -
     * <version> on <os>".
     *
     * <p>It is suggested that writers of new clients send this command once, after authentication
     * takes place.
     *
     * <p>args: the version string<br>
     * acknowledgement: none
     */
     ...
     * Kick
     *
     * <p>Kick somebody out of a room.
     *
     * <p>args: room, userid, (message)<br>
     ...
     * Invite
     *
     * <p>Invite somebody to a room.
     *
     * <p>args: room, userid<br>
     * acknowledgement: a confirmation message
     */
     ...
     * UnInvite
     *
     * <p>UnInvite somebody from a room.
     *
     * <p>args: room, userid<br>
     * acknowledgement: a confirmation message
     */
     ...
     * IgnoreList
     *
     * <p>List ignored users
     *
     * <p>args: none acknowledgement: list of users
     */
     ...
     * Mail
     *
     * <p>Queue mail for delivery to user
     *
     * <p>args: user, message body acknowledgement: MAIL_ACK
     */
     ...
     * Ignore
     *
     * <p>Mute Messages of another User.
     *
     * <p>args: userid of user to ignore, (message)<br>
     ...
     * Unignore
     *
     * <p>Unmute Messages of another User.
     *
     * <p>args: userid of user to remember, (message)<br>
     * acknowledgement: a general message
     */
     ...
     *
     * <p><i>When sent from the server...</i><br>
     * Denotes that a new user just joined a room, and will only be sent to clients who are
     * currently "in" that room.<br>
     * args: user, room
     *
     * @see #JOIN_ROOM_ACK
     */
     ...
     *
     * <p><i>When sent from the server...</i><br>
     * Denotes that a user just left a room, and will only be sent to clients who are currently "in"
     * that room.<br>
     * args: user, room
     *
     * @see #PART_ROOM_ACK
     ...
     *
     * <p>args: room, the message<br>
     * in response to: EMOTE, any time the server feels like sending a message that logically
     * belongs in a room.
     *
     * @see #EMOTE_TO_ROOM
     */
