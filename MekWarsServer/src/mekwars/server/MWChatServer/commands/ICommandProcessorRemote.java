...
public interface ICommandProcessorRemote {
     ...
     *
     * <p>The reason we pass name here is because this object doesn't have a particular name. The
     * name is really determined by the CommandProcessorRemote class. A command could possibly have
     * aliases, or it's name may change. To play it safe then, we will pass the name here in order
     * to derive the usage string.
     *
     * <p>Note: the output of this command might not be completely accurate. The output should
    ...
    /**
     * Return the minimum access level required to carry out this command. Access levels are defined
     * as constants in IAuthenticator.
     *
