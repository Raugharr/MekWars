...
public class ServerWrapper extends MWChatServer {
    ...
    public ServerWrapper(MWServ server) throws Exception {
        super(
                server.getConfigParam("SERVERIP"),
                Integer.parseInt(server.getConfigParam("SERVERPORT")));
    ...
    public InetAddress getIP(String username) {
        ...
        try {
            ...
            if (c == null) {
                MWLogger.mainLog(
                        "WARNING: Tried to get the IP from " + username + ", who is not here.");
     ...
     *     <p>This needs to be coupled a little more (or less) with the signon command object
     */
    @Override
