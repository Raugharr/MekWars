...
/**
 * The Feed class implements an RSS feed, getting the functionality out of CampaignMain This feed is
 * compliant with RSS 2.0, and will work with ITTT-Discord integration
 *
 * @author Spork
 * @version 1.0
 * @since 2018-02-18
...
public class Feed {
    ...
    private String getChannel() {
        ...
        sb.append(
                "<atom:link href=\""
                        + CampaignMain.cm.getConfig("NewsURL")
