...
public class BattleToJSON {
    ...
    public static void writeToFile(
            ShortOperation theOp,
            TreeMap<Integer, OperationEntity> livingUnitsMap,
            TreeMap<Integer, OperationEntity> deadUnitsMap,
        ...
        //    	String datetime = "8-22-12"; //need to look this up, theOp has a function that
        // returns a
        // long of time of match
        ...
        for (OperationEntity currOpEnt : deadUnitsMap.values()) {
            ...
            if (owner == null) {
                MWLogger.errLog(
                        "Null _owner_ while processing BattleToJson "
                                + " Attack #"
                                + theOp.getShortID()
                                + ". Needed to find Player: "
                                + ownerName
        ...
        try {
            ...
            Files.write(
                    Paths.get("./data/django/battles/" + fileName + ".json"),
                    jsonString.getBytes(),
