...
public class MWPasswd implements ICommands {
     ...
     * @throw AccessDenied if the user was found, but his password did not match the contents of the
     *     passwd file.
     */
    ...
    /**
     * Write a PasswdRecord to the passwd file. If an line already existed for the user specified,
     * it gets overwritten, otherwise, it is appended.
     *
    ...
    /**
     * Write a new entry to the passwd file. If an entry already exists for the given userId, it
     * gets overwritten, otherwise, it is appended. The password specified here gets encrypted.
     *
     * @param userId the user Id
    ...
    public static final void writeRecord(String userId, int access, String passwd)
        ...
        MWPasswdRecord r =
                new MWPasswdRecord(userId, access, passwd, System.currentTimeMillis(), "");
    ...
    private static final void showUsageAndExit() {
        MWLogger.errLog(
                "Passwd Program.  Adds new line to the passwd file, encrypting the password.");
        MWLogger.errLog(
                "usage: java com.lyrisoft.chat.server.remote.auth.Passwd "
