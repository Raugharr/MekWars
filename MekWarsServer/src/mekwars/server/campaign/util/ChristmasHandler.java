...
public class ChristmasHandler {
     ...
     *
     * <p>At some point, I may make this just a list, rather than a map. Right now, I'm not really
     * using it for anything that a list wouldn't serve for, but that may change.
     */
    ...
    protected ChristmasHandler() {
        ...
        try {
            startDate =
                    sdf.parse(
                            CampaignMain.cm.getCampaignOptions().getConfig("Christmas_StartDate"));
            endDate =
                    sdf.parse(CampaignMain.cm.getCampaignOptions().getConfig("Christmas_EndDate"));
    ...
    /**
     * Instantiates the ChristmasHandler if it is not yet instantiated. Returns the ChristmasHandler
     * if it is
     *
    ...
    public void endChristmas() {
        ...
        CampaignMain.cm
                .getCampaignOptions()
                .getConfig()
                .setProperty("Christmas_ManuallyStarted", "false");
