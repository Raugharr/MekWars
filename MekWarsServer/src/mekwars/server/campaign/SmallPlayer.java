...
/**
 * SmallPlayer is a lightweight player file which is NOT paged out of memory. Mirrors basic player
 * information which is needed when players are out of memoy (XP, Rating, Name) in order to publish
 * complete rankings and give accurate faction size information.
 *
