...
public class Battlefield implements GameInterface {
    ...
    private Hashtable<VirtualUnit, Hashtable<VirtualUnit, Integer>> distance =
            new Hashtable<VirtualUnit, Hashtable<VirtualUnit, Integer>>();
    ...
    public Battlefield(
            List<VirtualUnit> attackers, List<VirtualUnit> defenders, BattleReport battleReport) {
