 ...
 * @version 1.0
 * @since 2013-06-19
 *     <p>Calculate the spread. Intended to allow for multiple spread types (such as BV and
 *     tonnage).
 *     <p>Subclasses should implement 2 static methods:
 *     <p><code>
 ...
 *     public static int calcMax(SArmy a, boolean countSupport, boolean countInfantry, boolean countVehicles, boolean countAero, boolean countProtos, boolean ignorePilot)
 *     </code>
 *     <p>However, because of the static keyword in those, I cannot define them in either the
 *     abstract class or the interface
 */
public abstract class AbstractSpreadCalculator implements I_SpreadCalculator {
     ...
     */
    protected static boolean countUnit(
            Unit u,
            boolean countSupport,
            boolean countInfantry,
            boolean countVehicles,
            boolean countAero,
            boolean countProtos) {
        int type = u.getType();
