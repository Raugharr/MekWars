 ...
 * @version 1.0
 * @since 2013-06-19
 *     <p>Abstract class to validate unit spreads based on BV
 */
public abstract class BVSpreadValidator implements I_SpreadValidator {
    ...
    /**
     * Sets the class of the Validator. This is a specific bit of info potentially unnecessary.
     * Probably could just be done through an instanceof call. I'll think about this and probably
     * will kill it going forward.
     *
