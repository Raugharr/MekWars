...
public class OperationLoader {
    ...
    /**
     * Method which loads an operations values from server flat files. Unspecified values will
     * revert to hardcoded defaults.
     *
     * <p>NOTE: two files are read, but only one Properties/Hashmap is populated.
     *
     * <p>Also note: # can be used w/i op files as a comment. tabs are treated as whitespace.
     * property names are case sensitive.
     *
     * <p>Suggested formatting follows ... ---
     *
     * <p>#COMMENT RE: SETTING #MORE COMMENT DETAIL Param1 = value LongNameParam = value
     *
     * <p>#COMMENTS ON NEW BLOCK Param2 = value
     *
     * <p>- See Properties javadoc for additional commenting info.
     *
     * @urgru 5/30/05
     */
    ...
    /**
     * Method which loads modifying operations from flat files. Unspecified values revert to those
     * of the underlying operation first, and then to values from DefaultOperation.
     *
     * <p>Unlike standard operations, which read from 2 files, modops only read from one flat file.
     *
     * <p>See this.loadOpValues() and Properties javadoc for commenting info.
     *
     * <p>NOTE: addition of modops to standard Op's mod treemaps is handled in
