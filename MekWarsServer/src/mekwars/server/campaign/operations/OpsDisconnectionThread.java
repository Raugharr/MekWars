...
public class OpsDisconnectionThread extends Thread {
    ...
    public synchronized void run() {
        ...
        if (timeToReport < 120000) timeToReport = 120000;
        ...
        CampaignMain.cm.toUser(
                CampaignMain.cm.getPlayer(loserName).getColoredName()
        ...
        MWLogger.gameLog(
                "Autoreport: " + id + "/" + loserName + ". " + winnerName + " wins by forfeit");
    ...
    public void playerReturned(boolean tellOtherPlayer, long timeOffline) {
        if (tellOtherPlayer) {
            ...
            MWLogger.gameLog(
                    "Disco Thread/Stop:" + id + "/" + loserName + ". Player threads cleared.");
        }
        playerReturned = true;
    }
    ...
    /**
     * Method is used by Operation Manager's doDisconnectCheckOnPlayer method in orderto determine
     * whether or not to cancel game.
     *
