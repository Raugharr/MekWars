...
public class Vote {
     ...
     *     <p>Types are declared as public final ints in Vote.java
     */
    public int getType() {
        return voteType;
    }
     ...
     *     <p>Take two votes and see if they have the same elements: Caster, Recipient and Type.
     */
    public boolean isEqualTo(Vote v, boolean typeCounts) {
        ...
        if (this.getCaster().equals(v.getCaster())) sameCaster = true;
        if (this.getRecipient().equals(v.getRecipient())) sameRecipient = true;
        if (this.getType() == v.getType()) sameType = true;
