 ...
 *     <p>The VoteManager controls all vote casting and counting for a campaign.
 *     <p>Current implementation uses phenomenally inefficient vector sorting and doesnt save its
 *     contents. At some point, McWizard will change this to use Hibernate and make it not suck. =)
 *     <p>Houses and players use the VoteManager to get access to information they need. Lists of
 *     outstanding votes, player vote totals, etc. So long as these calls are duplicated when the VM
 *     is Hibernated, and return vote vectors, nothing in SHouse or SPlayer should be broken by the
 *     transition.
 */
public class VoteManager {
     ...
     *     <p>Check to see if a vote has an equivalent (same caster and recipient already in the
     *     collection).
     *     <p>Generally speaking, players are only be allowed to vote once for any other player --
     *     positive, negative or otherwise. So no need to check the type.
     */
     ...
     *     <p>quick check to make sure player casting vote and player receiving vote are in the same
     *     faction.
     */
     ...
     *     <p>Takes a vote object and appends it to the voteVector. Votes should only generated by
     *     VoteCommand.java
     *     <p>Don't add duplicate votes. Don't add votes outside of a faction.
     */
     ...
     *     <p>Run through an iterator, comparing a newly generated vote to the Managed votes. If A
     *     vote like the new vote exists, remove it from the vote vector.
     */
     ...
     *     <p>Takes results of getAllVotesFor(Player) and filters by vote type.
     */
     ...
     * @param type vote type to look for
     * @return Vector of votes
     *     <p>Takes results of getAllVotesBy(Player) and filters by vote type.
     */
     ...
     *     <p>Removes all votes for a player. alled by Sfaction when a player is removed.
     */
     ...
     *     <p>Removes all votes cast by a player. Called by Sfaction when a player is removed.
     */
     ...
     *     <p>Queries all votes, collects votes cast by players of the given faction, and returns a
     *     vector.
     */
