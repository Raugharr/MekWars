...
public class NamePilotCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "AM:Improper syntx. Try: /c namepilot#unitid#newname", Username, true);
            return;
        }
        ...
        if (p == null) {
            CampaignMain.cm.toUser(
                    "AM:Null player while naming pilot. Report to an admin.", Username, true);
            return;
        }
        ...
        if (pilot == null) {
            CampaignMain.cm.toUser(
                    "AM:Unit #" + unitid + " has a null pilot. Report this to an admin.",
                    Username,
                    true);
            return;
        }
        ...
        if (pilot.getName().toLowerCase().startsWith("vacant")) {
            CampaignMain.cm.toUser(
                    "AM:There is no pilot in that unit! It is vacant!", Username, true);
            return;
        }
