...
public class BuildTableListCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (command.hasMoreTokens()) filePath = command.nextToken();
        ...
        try {
            ...
            if (file.isDirectory()) {
                ...
                for (int i = 0; i < fileList.length; i++)
                    results +=
                            "<a href=\"MEKWARS/c buildtablelist#"
                                    + filePath
                                    + "/"
                                    + fileList[i]
                                    + "\">"
                ...
                while (dis.ready()) {
                    ...
                    if (line.indexOf(".") != -1) {
                        ...
                        if (ent.getModel().equals("OMG-UR-FD")) {
                            MWLogger.errLog(
                                    fileWithOutChance + " errored in Build Table: " + filePath);
