...
public class CodeTestCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (!command.hasMoreTokens()) {
            CampaignMain.cm.toUser(
                    "AM: invalid syntax: try /codetest start or /codetest stop", Username, false);
            return;
        }
        ...
        switch (action) {
            ...
            case ACTION_STOP:
                //			try {
                //				CampaignMain.cm.getScheduler().unscheduleJob(new TriggerKey("trigger1",
                // "group1"));
                ...
                //						CampaignMain.cm.doSendModMail("SERVER", "Found Job Identified by: " +
                // jobKey);
                //					}
                //				}
                //
