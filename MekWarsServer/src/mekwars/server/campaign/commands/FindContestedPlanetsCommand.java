...
public class FindContestedPlanetsCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            sret =
                    "AM:Could not find attacking faction.<br>...Try /FindCP#AttackingHouse#DefendingHouse#%Owned";
            ...
            sret =
                    "AM:Could not find defending faction.<br>...Try /FindCP#AttackingHouse#DefendingHouse#%Owned";
            ...
            sret =
                    "AM:Could not resolve %Owned to a postive integer.<br>...Try /FindCP#AttackingHouse#DefendingHouse#%Owned";
            ...
            String s =
                    "<br><b><u>Contested Planet list with minimum "
                            + PercentAmount
                            + "% owned for "
                            + h1.getColoredName()
                            + " attacking "
            ...
            while (it.hasNext()) {
                ...
                if (p.getInfluence().getInfluence(h1.getId())
                                >= 0.01 * PercentAmount * p.getConquestPoints()
            ...
            while (i.hasNext()) {
                ...
                s +=
                        h1.getColoredAbbreviation(false)
                                + " "
