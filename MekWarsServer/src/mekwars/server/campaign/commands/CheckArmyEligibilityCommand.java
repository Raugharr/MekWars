...
public class CheckArmyEligibilityCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "AM:Improper command. Try: /c checkarmyeligibility#id#operation",
                    Username,
                    true);
            return;
        }
        ...
        if (s != null && !s.trim().equals("")) {
            CampaignMain.cm.toUser(
                    "AM:" + opName + " is illegal for Army #" + armyid + " " + s, Username, true);
            return;
        }

        // else
        CampaignMain.cm.toUser(
                "AM:" + opName + " is legal for Army #" + armyid + ".", Username, true);
    } // end process
