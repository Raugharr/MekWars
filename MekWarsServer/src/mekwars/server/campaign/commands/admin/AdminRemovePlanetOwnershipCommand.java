...
public class AdminRemovePlanetOwnershipCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            removingHouse =
                    CampaignMain.cm.getHouseFromPartialString(command.nextToken(), Username);

        } catch (Exception e) {
            CampaignMain.cm.toUser(
                    "Improper command. Try: /c adminremoveplanetownership#planet#faction",
                    Username,
                    true);
            return;
        }
