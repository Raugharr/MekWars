...
public class AdminScrapCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        CampaignMain.cm.toUser(
                "AM:" + targetName + "'s " + m.getModelName() + " was scrapped.", Username, true);
        CampaignMain.cm.toUser(
                "AM:" + Username + " scrapped your " + m.getModelName() + " (ID#" + m.getId() + ")",
                targetName,
                true);
        // server.MWLogger.modLog(Username + " scrapped a "+ m.getModelName() + " belonging to " +
        // targetName);
