    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            Continent cont =
                    new Continent(
                            chance,
                            CampaignMain.cm.getData().getTerrainByName(terraintype),
                            CampaignMain.cm.getData().getAdvancedTerrainByName(advTerrainType));
            p.getEnvironments().add(cont);
            p.updated();

            // server.MWLogger.modLog(Username + " added terrain to " + p.getName() + " (" +
            // terraintype +
            // ").");
            CampaignMain.cm.toUser(
                    "Terrain added to "
