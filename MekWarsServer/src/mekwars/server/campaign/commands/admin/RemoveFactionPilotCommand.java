...
public class RemoveFactionPilotCommand implements Command {
    ...
    String syntax =
            "Faction Name#Type[Mek,Vehicle,Infantry,Proto,BattleArmor,Aero]/ALL#Position[Not used if ALL is selected]";
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            if (type.equalsIgnoreCase("all")) {
                ...
                if (position.equalsIgnoreCase("all")) {
                    ...
                    h.getPilotQueues()
                            .getPilotQueue(Unit.getTypeIDForName(type))
                            .remove(Integer.parseInt(position));
                }
            }
        } catch (Exception ex) {
            CampaignMain.cm.toUser(syntax, Username);
        ...
        CampaignMain.cm.doSendModMail(
                "NOTE", Username + " has removed pilots from " + h.getName() + "'s pilot queue");
    }
}
