...
public class ChangeNameCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "Improper command. Try: /c changename#oldname#newname", Username, true);
            return;
        }
        ...
        if (p.getDutyStatus() != SPlayer.STATUS_RESERVE) {
            CampaignMain.cm.toUser(
                    "You may only rename players who are in reserve.", Username, true);
            return;
        }
        ...
        CampaignMain.cm.toUser(
                "You changed " + oldName + "'s name to '" + newName + "'.", Username, true);
        CampaignMain.cm.doSendModMail(
                "NOTE", Username + " changed " + oldName + "'s name to '" + newName + "'.");
        CampaignMain.cm.toUser(
                Username
