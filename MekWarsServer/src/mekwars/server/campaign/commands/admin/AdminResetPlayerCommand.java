    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (resetType.equalsIgnoreCase("all")) {
            ...
            for (int i = 0; i < playerList.length; i++) {
                ...
                SPlayer player =
                        CampaignMain.cm.getPlayer(
                                playerFile
                                        .getName()
                                        .substring(0, playerFile.getName().indexOf(".dat")));
            ...
            // server.MWLogger.modLog(Username + " has reset all player accounts for faction
            // "+resetType);
            CampaignMain.cm.doSendModMail(
                    "NOTE", Username + " has reset all player accounts for faction " + resetType);
            ...
            CampaignMain.cm.doSendModMail(
                    "NOTE", Username + " has reset " + player.getName() + "'s account.");
        }
