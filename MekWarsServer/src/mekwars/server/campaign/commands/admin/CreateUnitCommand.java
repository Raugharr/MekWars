 ...
 *
 * <p>This command allows an admin to create a unit, which is then dropped into his hangar
 *
 * @version 2016.10.26
 */
public class CreateUnitCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        CampaignMain.cm.toUser(
                ...
                Username,
                true);
        // server.MWLogger.modLog(Username + " created a unit: " + filename + " " + FlavorText + " "
        // +
        // gunnery + " " + piloting+" "+pilot.getSkillString(true));
