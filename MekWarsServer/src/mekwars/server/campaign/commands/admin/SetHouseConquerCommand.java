...
public class SetHouseConquerCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "Improper command. Try: /c sethouseconquer#Faction#true/false", Username, true);
            return;
        }
        ...
        CampaignMain.cm.toUser(
                "You set " + h.getName() + "'s conquer status to " + conquer, Username, true);
        // server.MWLogger.modLog(Username + " has changed the conquer status for " + h.getName()+"
        // to
        // "+conquer);
