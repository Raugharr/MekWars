...
public class SetPlanetConquerCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "Improper command. Try: /c setplanetconquer#planet#true/false", Username, true);
            return;
        }
        ...
        CampaignMain.cm.toUser(
                "You set " + p.getName() + "'s conquer status to " + conquer, Username, true);
        // server.MWLogger.modLog(Username + " has changed the infaction conquer for " +
        // p.getName()+"
        // to "+conquer);
