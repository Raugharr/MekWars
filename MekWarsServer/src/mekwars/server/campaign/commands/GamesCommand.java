    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (command.hasMoreElements()) {
            try {
                ...
                CampaignMain.cm.toUser(
                        "AM:Games command failed. Check your input. It should be:"
        ...
        for (ShortOperation currO : CampaignMain.cm.getOpsManager().getRunningOps().values()) {
            ...
            // add waiting, running and reporting games to runningGames
                ...
                else currInfo += "<br>" + currO.getInfo(false, false);
        ...
        if (runningGamesCount == 0) runningGames += "<br>- None";

        // list finished games
        if (timeSort.size() == 0) finishedGames += "<br>- None";
        else {
