...
public class BanCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            if (command.hasMoreTokens()) {
                ...
                if (banTime.equalsIgnoreCase("perm")) {
                    ...
                    if (banValue.trim().equalsIgnoreCase("h")) {
                        ...
                        howlong =
                                Long.parseLong(banTime.substring(0, banTime.length() - 1)) * month;
            ...
            if (banip.equals(InetAddress.getLocalHost())) banip = null;

            long until = System.currentTimeMillis() + howlong;
            CampaignMain.cm.toUser(
                    "AM:You were banned by " + Username + " " + timeName + ".", toKill);
            ...
            if (banip != null) MWServ.getInstance().getBanIps().put(banip, until);
            ...
            CampaignMain.cm.toUser(
                    "AM:Incorrect Syntax: Syntax is as follows<br>/ban playername#time"
