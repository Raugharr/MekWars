...
public class ModGamesCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (p == null) {
            CampaignMain.cm.toUser(
                    "Null player. Contact an administrator to report this, immediately!",
                    Username,
                    true);
            return;
        }
        ...
        if (command.hasMoreElements()) {
            try {
                ...
                CampaignMain.cm.toUser(
                        "Games command failed. Check your input. It should be:"
        ...
        if (runningGamesCount == 0) runningGames += "- None<br>";
