...
public class GooseCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            if (p == null) {
                CampaignMain.cm.toUser(
                        "AM:Sorry you cannot find " + player + " to goose!", Username);
                return;
            }
            ...
            if (p.getName().equalsIgnoreCase("torren")
                ...
                CampaignMain.cm.toUser(
                        ...
                        Username);
                CampaignMain.cm.toUser(
                        Username + " tried to goose you but you deftly avoided it!", p.getName());
                CampaignMain.cm.doSendModMail(
                        "NOTE",
                        Username
                                + " tried to goose "
                                + p.getName()
                                + " and nearly lost their hand for it.");
                return;
            }
            ...
            CampaignMain.cm.toUser(
                    "AM:You really need to specify whom you would like to goose", Username);
            return;
        }
    }
}
