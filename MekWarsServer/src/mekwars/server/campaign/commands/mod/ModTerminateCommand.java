...
public class ModTerminateCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "Improper format. Try: /c modterminate#game number", Username, true);
            return;
        }
        ...
        for (String currPlayerName : so.getAllPlayerNames()) {
            ...
            if (playerCounter == totalPlayers) players += " and ";
            else if (playerCounter > totalPlayers) players += ".";
            else players += ", ";
        }

        CampaignMain.cm.toUser(
                "AM:You terminated Attack #" + opID + ". " + players, Username, true);
        // server.MWLogger.modLog(Username + " terminated Attack #" + opID + ". " + players);
        CampaignMain.cm.doSendModMail(
                "NOTE", Username + " terminated Attack #" + opID + ". " + players);
    } // end process()
