...
public class BanListCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        ConcurrentHashMap<String, String> banHash =
                new ConcurrentHashMap<String, String>(MWServ.getInstance().getBanAccounts());
        ...
        ConcurrentHashMap<InetAddress, Long> banIpHash =
                new ConcurrentHashMap<InetAddress, Long>(MWServ.getInstance().getBanIps());
