...
public class SetMOTDCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (p.getExperience() < minExp) {
            CampaignMain.cm.toUser(
                    "AM:Your exp is too low you must have "
                            + minExp
                            + " XP in order to use setmotd.",
                    Username,
                    true);
            return;
        }
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "AM:Improper syntax. Try: /setmotd text or /setmotd clear", Username, true);
            return;
        }
