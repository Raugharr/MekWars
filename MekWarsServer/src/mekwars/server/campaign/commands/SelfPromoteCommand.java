    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (accessLevel != 0) {
            ...
            if (userLevel > getExecutionLevel() && userLevel < 100) {
                CampaignMain.cm.toUser(
                        "AM:Access level is too high for this command. Level: "
                                + userLevel
                                + ". Required: "
                                + accessLevel
                                + ".",
        ...
        CampaignMain.cm.doSendToAllOnlinePlayers(
                "PI|FT|" + user.getName() + "|" + user.getFluffText(), false);
        CampaignMain.cm.doSendToAllOnlinePlayers(
                "PI|SSN|" + user.getName() + "|" + subFactionName, false);
        ...
        CampaignMain.cm.toUser(
                "AM:You've promoted " + user.getName() + " to SubFaction " + subFactionName + ".",
                Username);
