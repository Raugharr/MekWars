...
/**
 * JoinAttackCommand is used to join a faction ShortOperations. Checks the validity of the attacking
 * force. syntax JoinAttack attackingPlayerName#JoiningPlayersArmyId
 */
public class JoinAttackCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        boolean minActiveMet =
                (System.currentTimeMillis() - jp.getActiveSince())
        ...
        if (o == null) {
            CampaignMain.cm.toUser(
                    "AM:Short Operation not found for " + ap.getName() + ".", Username);
            return;
        }
        ...
        CampaignMain.cm.toUser(
                "AM:You have been assigned to team #" + ap.getTeamNumber(), Username);
