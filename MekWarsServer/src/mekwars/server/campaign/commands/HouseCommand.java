...
public class HouseCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        while (it.hasNext()) {
            ...
            // update lists
            if (p.getOwner() != null && p.getOwner().equals(h)) ownedWorlds.add(p);
            else if (ownership > 0) contestedWorlds.add(p);
        }
        ...
        s +=
                "Total Economic Value: "
                        ...
                        + "<br>"
                        + "  - Avg. Planet: "
                        + h.getComponentProduction() / ownedWorldsSize
                        + "<br>"
                        + "  - Per Capita: "
                        + h.getComponentProduction() / sinceLastRestart
                        + "<br><br>";
        ...
        if (CampaignMain.cm.getPlayer(Username).getMyHouse().equals(h)
        ...
        if (gameStrings.trim().equals("")) s += "none.<br>";
        else s += gameStrings + "<br>";
