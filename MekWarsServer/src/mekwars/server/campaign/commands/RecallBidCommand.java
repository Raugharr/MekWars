...
public class RecallBidCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (p == null) {
            CampaignMain.cm.toUser(
                    "AM:Null SPlayer while recalling bid. Report immediately!", Username, true);
            return;
        }
        ...
        try {
            ...
            CampaignMain.cm.toUser(
                    "AM:Improper format. Try: /c recallbid#AuctionID", Username, true);
            return;
        }
        ...
        bidList.placeBid(
                Username,
                -1); // placing a negative bid actually removes from the Hash. See MarketListing.

        // let the player know the bid was recalled
        CampaignMain.cm.toUser(
                "AM:You've rescinded your bid for the "
