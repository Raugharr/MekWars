...
public final class HighestSealedBidAuction implements IAuction {
    ...
    /**
     * Winner is simply the highest offering person who can afford to pay. This, codewise, is a
     * truncated Vickrey Auction. Same mechanism to find highest bidder, but no downward adjustment.
     */
