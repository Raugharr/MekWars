...
ALTER TABLE player ADD COLUMN selling_to TEXT NOT NULL;
ALTER TABLE player ADD COLUMN client_version TEXT;
...
ALTER TABLE house ADD COLUMN activitypp REAL NOT NULL;
ALTER TABLE house ADD COLUMN type_size INTEGER NOT NULL;
ALTER TABLE house ADD COLUMN weight_size INTEGER NOT NULL;
ALTER TABLE house ADD COLUMN leaders TEXT NOT NULL;
ALTER TABLE house ADD COLUMN timestamp INTEGER NOT NULL;
ALTER TABLE house ADD COLUMN unit_components_id INTEGER NOT NULL;

CREATE INDEX player_unit_components_id_index ON player(unit_components_id);

ALTER TABLE pilot ADD COLUMN picked_up_id INTEGER;
ALTER TABLE pilot ADD COLUMN death INTEGER;
