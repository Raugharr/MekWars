...
public final class ArmySorter {
    ...
    private static final MultiPassSorter<CArmy> sorter =
            new MultiPassSorter<>(
                    SORT_CHOICES, CArmyComparator::new, CArmyComparator.ARMYSORT_NONE);

    public static void sort(List<CArmy> armies, List<String> sortingOrder) {
        sorter.sort(armies, sortingOrder);
    }
