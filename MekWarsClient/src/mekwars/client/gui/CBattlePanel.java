                ...
                new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        if (e.getClickCount() == 2) {
                            String curName =
                                    (String)
                                            battleSorter.getValueAt(
                                                    BattleTable.rowAtPoint(e.getPoint()),
                                                    0); // host name
    ...
    class BattlePopupListener extends MouseAdapter implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            if (s.startsWith("RESTART|")) {
                ...
                if (result == JOptionPane.YES_OPTION)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",clearowners");
                ...
                if (result != null && result.length() > 1)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",owner " + result);
                ...
                if (result != null && result.length() > 1)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",port " + result);
                ...
                String currName = s.substring(s.indexOf('|') + 1);
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",displaysavedgames");
            } else if (s.startsWith("DMML|")) {
                String currName = s.substring(s.indexOf('|') + 1);
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",displaymegameklog");
            } else if (s.startsWith("DDEL|")) {
                String currName = s.substring(s.indexOf('|') + 1);
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",displaydederrorlog");
                ...
                if (result != null)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",loadgame " + result);
                ...
                if (result == JOptionPane.YES_OPTION)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",loadautosave");
                ...
                if (result != null && result.length() > 1) {
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",name " + result);
                    mwclient.sendChat(GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",die");
                }
                ...
                if (result != null && result.length() > 1)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",comment " + result);
                ...
                if (result != null && result.length() > 0)
                    mwclient.sendChat(
                            GameHost.CAMPAIGN_PREFIX + "mail " + currName + ",players " + result);
    ...
    class BattlesModel extends AbstractTableModel {
        ...
        class Renderer extends DefaultTableCellRenderer {
            ...
            public java.awt.Component getTableCellRendererComponent(
                ...
                else if (game.getStatus().equals("Open")) c.setBackground(Color.green);
                else if (game.getStatus().equals("Running")) c.setBackground(Color.yellow);
