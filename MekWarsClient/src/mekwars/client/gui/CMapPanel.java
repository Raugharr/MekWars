 ...
 *
 * <p>The map is drawn online at demand. Hope the speed is ok.
 *
...
public class CMapPanel extends JPanel {
    ...
    public CMapPanel(MWClient client, CMainFrame mainFrame, int xsize, int ysize) {
        ...
        // if the map is visible, select the correct planet last(since this involves several
        // updates)
