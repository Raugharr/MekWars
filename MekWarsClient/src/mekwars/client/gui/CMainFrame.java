...
public class CMainFrame extends JFrame {
    ...
    public CMainFrame(MWClient myC) {
        ...
        setTitle(
                mwclient.getConfigParam("CAMPAIGNSERVERNAME")
                        + " (MekWars Client "
    ...
    public void enableMenu() {
        ...
        jMenuLeaderDemote.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("DemotePlayer"));
        jMenuLeaderFluff.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("FactionLeaderFluff"));
        jMenuLeaderMute.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("FactionLeaderMute"));
        jMenuLeaderPromote.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("PromotePlayer"));
        jMenuLeaderFactionColor.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("ChangeHouseColor"));
        jMenuLeaderPlayerColor.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("AdminSetHousePlayerColor"));
        jMenuLeaderPurchaseFactory.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("PurchaseFactory"));
        jMenuLeaderResearchTech.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("ResearchTechLevel"));
        jMenuLeaderResearchUnit.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("ResearchUnit"));
        jMenuLeaderSetComponentConversion.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("SetComponentConversion"));
        jMenuLeaderViewFactionPartsCache.setVisible(
                userLevel >= mwclient.getData().getAccessLevel("ViewFactionPartsCache"));
        ...
        jMenuCampaignDirectSell.setVisible(
                Boolean.parseBoolean(mwclient.getServerConfigs("UseDirectSell")));
    ...
    protected void createMenu() throws Exception {
        ...
        jMenuFileConnect.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFileDisconnect.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFileRegister.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFileMail.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFileLastOnline.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFileConfig.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignLogin.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignActivate.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        mwclient.sendChat(
                                GameHost.CAMPAIGN_PREFIX + "c activate#" + MWClient.CLIENT_VERSION);
                    }
                });

        jMenuCampaignDeactivate.setText("Deactivate");
        // jMenuCampaignDeactivate.setMnemonic('R');
        jMenuCampaignDeactivate.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignLogout.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignPlayers.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignISStatus.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignFactionStatus.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignHouses.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignMyStatus.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignCheckAttack.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignRange.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuFindContestedPlanets.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignTransferUnit.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignTransferMoney.setText(
                "Transfer " + mwclient.moneyOrFluMessage(true, true, -2));
        jMenuCampaignTransferMoney.setMnemonic('C');
        jMenuCampaignTransferMoney.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignLogo.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignPersonalPilotQueue.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignDonatePersonalPilot.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignDirectSell.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignTransferPilot.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignDefect.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        // jMenuCampaignDefect.setMnemonic('D');
        jMenuCampaignSelfPromote.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignReportStatusMC.setText(
                "Check MiniCampaign Status"); // @salient for mini campaign
        // jMenuCampaignDefect.setMnemonic('D');
        jMenuCampaignReportStatusMC.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignRewardPoints.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        // jMenuCampaignRewardPoints.setMnemonic('P');
        jMenuCampaignInfluencePoints.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCampaignPartsCache.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        if (useAdvanceRepairs) {
            ...
            jMenuSubCampaignBuyBays.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuSubCampaignSellBays.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
        ...
        if (usePersonalPilotQueues) {
            ...
            jMenuCampaignBuyPilots.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
        ...
        jMenuSubCampaignHireTechs.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuSubCampaignFireTechs.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuMercOfferContract.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuMercStatus.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuMercUnemployed.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuMercContracted.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuCSHostAndJoin.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        startHost();
        ...
        jMenuCSHostDedicated.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        startHost();
        ...
        jMenuCSHostLoad.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        startHost();
        ...
        jMenuCSHostLoadAndJoin.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        startHost();
        ...
        jMenuCSHostStop.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        stopHost();
                        mwclient.stopHost();
        ...
        jMenuOptionsAutoScroll.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuOptionsMute.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuOptionsReloadAllData.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        mwclient.reloadData();
                    }
        ...
        jMenuLeaderPromote.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderDemote.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderFluff.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderMute.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderFactionColor.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderPlayerColor.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderResearchUnit.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderResearchTech.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderPurchaseFactory.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderSetComponentConversion.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuLeaderViewFactionPartsCache.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpMemory.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpHelp.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpViewUnit.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpViewBuildTables.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpViewTraits.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpPilotSkills.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuHelpOpViewer.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        ActionListener mekwarsListener =
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        try {
                            Browser.displayURL(
                                    "http://sourceforge.net/tracker/?group_id=122002&atid=692058");
                        } catch (Exception ex) {
                            MWLogger.errLog(ex);
                        }
                    }
                };
        ActionListener megamekListener =
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        try {
                            Browser.displayURL(
                                    "http://sourceforge.net/tracker/?group_id=47079&atid=448394");
                        } catch (Exception ex) {
                            MWLogger.errLog(ex);
                        }
                    }
                };
        ActionListener megamekRFEListener =
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        try {
                            Browser.displayURL(
                                    "http://sourceforge.net/tracker/?group_id=47079&atid=448397");
                        } catch (Exception ex) {
                            MWLogger.errLog(ex);
                        }
                    }
                };
        ActionListener mekwarsRFEListener =
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        try {
                            Browser.displayURL(
                                    "http://sourceforge.net/tracker/?group_id=122002&atid=692061");
                        } catch (Exception ex) {
                            MWLogger.errLog(ex);
                        }
                    }
        ...
        if (Boolean.parseBoolean(mwclient.getServerConfigs("AllowEmoji"))) {
            ...
            jMenuEmojiFlip.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuEmojiShrug.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuEmojiFingers.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuEmojiKiss.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuEmojiSmile.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
            ...
            jMenuEmojiDeal.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
    ...
    public void jMenuMercStatus_actionPerformed() {
        PlayerNameDialog playerDialog =
                new PlayerNameDialog(
                        mwclient, "Which Merc do you want info on?", PlayerNameDialog.MERCS_ONLY);
    ...
    public void jMenuFindContestedPlanets_actionPerformed() { // BarukKhazad 20151129 - start 2
        ...
        HouseNameDialog factionDialog =
                new HouseNameDialog(mwclient, "Target Faction", false, false);
        factionDialog.setVisible(true);
    ...
    public void jMenuCommanderTransferMoney_actionPerformed(String name) {
        ...
        if ((name == null) || name.trim().equals("")) {
            PlayerNameDialog pnd =
                    new PlayerNameDialog(
                            mwclient, "Transfer Recipient", PlayerNameDialog.FACTION_ONLY);
            pnd.setVisible(true);
        ...
        mwclient.sendChat(
                GameHost.CAMPAIGN_PREFIX + "c transfermoney#" + targetPlayer + "#" + Amount);
    }
    ...
    public void jMenuCommanderTransferRewardPoints_actionPerformed(String name) {
        ...
        mwclient.sendChat(
                GameHost.CAMPAIGN_PREFIX + "c transferrewardpoints#" + targetPlayer + "#" + Amount);
    }
    ...
    public void jMenuCommanderTransferInfluence_actionPerformed(String name) {
        ...
        mwclient.sendChat(
                GameHost.CAMPAIGN_PREFIX + "c transferinfluence#" + targetPlayer + "#" + Amount);
    }
    ...
    public void jMenuCommanderTransferUnit_actionPerformed(String name, int mid) {
        ...
        if (mid == -1) {
            UnitSelectionDialog usd =
                    new UnitSelectionDialog(mwclient, "Transfer Unit", "Select unit to transfer:");
            usd.setVisible(true);
    ...
    public void jMenuCommanderSetLowerUnitLimit_actionPerformed(int aid) {
        ...
        String limit =
                JOptionPane.showInputDialog(
                        getContentPane(),
                        "<HTML>"
                                + "Lower Limit? [-1 to disable the limit]<i><br><br>"
                                + example
                                + "<br></i></HTML>",
    ...
    public void jMenuCommanderSetUpperUnitLimit_actionPerformed(int aid) {
        ...
        String limit =
                JOptionPane.showInputDialog(
                        getContentPane(),
                        "<HTML>"
                                + "Upper Limit? [-1 to disable the limit]<i><br><br>"
                                + example
                                + "<br></i></HTML>",
    ...
    public void jMenuCommanderSetForceSizeToFace_actionPerformed(int aid) {
        ...
        String force =
                JOptionPane.showInputDialog(
                        getContentPane(),
                        "<HTML>"
                                + "Force Size To Face    ? [-1 to disable the limit]<i><br><br>"
                                + example
                                + "<br></i></HTML>",
    ...
    public void jMenuCommanderTransferPilot_actionPerformed(String name) {
        ...
        if (mwclient.getPlayer().getPersonalPilotQueue().getPilotQueue(unitType, weightClass).size()
                < 1) {
        ...
        Object[] pilots =
                mwclient.getPlayer()
                        ...
                        .getPilotQueue(unitType, weightClass)
                        .toArray();
        ...
        JOptionPane jop =
                new JOptionPane(combo, JOptionPane.QUESTION_MESSAGE, JOptionPane.OK_CANCEL_OPTION);
    ...
    public void jMenuCommanderDirectSell_actionPerformed(String name, String id) {
        ...
        if ((name == null) || name.trim().equals("")) {
            PlayerNameDialog pnd =
                    new PlayerNameDialog(mwclient, "Buyer", PlayerNameDialog.ANY_PLAYER);
            pnd.setVisible(true);
        ...
        if ((id == null) || id.trim().equals("")) {
            UnitSelectionDialog usd =
                    new UnitSelectionDialog(mwclient, "Unit", "Select a unit to sell");
            usd.setVisible(true);
        ...
        price =
                JOptionPane.showInputDialog(
                        ...
                        "How much do you wish to offer? ("
                                ...
                                + mwclient.moneyOrFluMessage(
                                        true,
                                        true,
                                        Integer.parseInt(mwclient.getServerConfigs(serviceFee)))
                                + " will be added.");
    ...
    public void jMenuCommanderDefect_actionPerformed() {
        ...
        if (Boolean.parseBoolean(mwclient.getServerConfigs("AllowSinglePlayerFactions"))) {
            ...
            mwclient.sendChat(
                    GameHost.CAMPAIGN_PREFIX + "c defect#" + House + "#newfaction#" + shortName);

            return;
        }

        HouseNameDialog factionDialog =
                new HouseNameDialog(mwclient, "Defect to faction:", false, true);
        factionDialog.setVisible(true);
        House = factionDialog.getHouseName();
        factionDialog.dispose();
    ...
    public void jMenuCommanderSelfPromote_actionPerformed() {
        ...
        SubFactionNameDialog subFactionDialog =
                new SubFactionNameDialog(mwclient, "SubFaction", mwclient.getPlayer().getHouse());
    ...
    public void jMenuCommanderFireTechs_actionPerformed() {
        ...
        String techsToFire =
                JOptionPane.showInputDialog(
                        getContentPane(), "How many techs do you want to fire?");
        ...
        if (!useAdvanceRepairs && ((techs < 1) || (techs > thePlayer.getTechs()))) {
            mwclient.addToChat(
                    "<b>Try picking a number between 1 and " + thePlayer.getTechs() + "<b>");
            return;
        }
    ...
    public void jMenuCommanderHireTechs_actionPerformed() {
        boolean allowRegTechs =
                Boolean.parseBoolean(mwclient.getServerConfigs("AllowRegTechsToBeHired"));
            ...
            techsToHire =
                    JOptionPane.showInputDialog(
                            ...
                            "How many green techs do you want to hire?("
                                    + Integer.parseInt(
                                            mwclient.getServerConfigs("GreenTechHireCost"))
                                    + mwclient.moneyOrFluMessage(true, true, -2)
                                    + ")");
        } else {
            techsToHire =
                    JOptionPane.showInputDialog(
                            getContentPane(), "How many techs do you want to hire?");
        }
    ...
    public void jMenuCampaignSubOtherBuyPilots_actionPerformed() {
        ...
        String numberOfPilots =
                JOptionPane.showInputDialog(
                        getContentPane(), "How many pilots do you want to hire?", 1);
    ...
    public void jMenuCommanderSellBays_actionPerformed() {
        String baysToFire =
                JOptionPane.showInputDialog(
                        getContentPane(), "How many bays do you want to return??");
        ...
        if ((bays < 1) || (bays > thePlayer.getFreeBays())) {
            mwclient.addToChat(
                    "<b>Try picking a number between 1 and " + thePlayer.getFreeBays() + "<b>");
            return;
        }
    ...
    public void jMenuHelpViewUnit_actionPerformed() {
        ...
        // UnitViewerDialog unitSelector = new UnitViewerDialog(mwclient.getMainFrame(),
        // unitLoadingDialog, mwclient, UnitViewerDialog.UNIT_VIEWER);
        NewUnitViewerDialog unitSelector =
                new NewUnitViewerDialog(
                        this, unitLoadingDialog, mwclient, NewUnitViewerDialog.UNIT_VIEWER);
    ...
    public void jMenuLeaderPromote_actionPerformed() {
        ...
        int menuType =
                mwclient.isMod() ? PlayerNameDialog.ANY_PLAYER : PlayerNameDialog.FACTION_ONLY;
        ...
        SubFactionNameDialog subFactionDialog =
                new SubFactionNameDialog(
                        mwclient, "SubFaction", mwclient.getUser(targetPlayer).getHouse());
        subFactionDialog.setVisible(true);
        String subFactionName = subFactionDialog.getSubFactionName();
        subFactionDialog.dispose();
    ...
    public void jMenuLeaderDemote_actionPerformed() {
        ...
        mwclient.sendChat(
                GameHost.CAMPAIGN_PREFIX + "c demoteplayer#" + targetPlayer + "#" + subFactionName);
    }
    ...
    public void jMenuLeaderFluff_actionPerformed() {
        ...
        String newfluff =
                JOptionPane.showInputDialog(
                        this, "Fluff? (Leave blank to remove)", user.getFluff());
    ...
    public void jMenuLeaderFactionColor_actionPerformed() {
        String newColor =
                JOptionPane.showInputDialog(
                        this, "Faction Color?", "Faction Color?", JOptionPane.QUESTION_MESSAGE);
    ...
    public void jMenuLeaderPlayerColor_actionPerformed() {
        String newColor =
                JOptionPane.showInputDialog(
                        this, "Player Color?", "Player Color?", JOptionPane.QUESTION_MESSAGE);
    ...
    public void jMenuLeaderPurchaseFactory_actionPerformed(String planet) {
        ...
        String factoryName =
                JOptionPane.showInputDialog(
                        this, "Factory Name?", "Factory Name?", JOptionPane.QUESTION_MESSAGE);
        ...
        if (planet == null) {
            ...
            PlanetNameDialog planetDialog =
                    new PlanetNameDialog(mwclient, "Choose a planet", opString);
    ...
    public void jMenuHelpAbout_actionPerformed() {
        ...
        JLabel version = new JLabel("MegaMek Version: " + megamek.MMConstants.VERSION);
    ...
    public void jMenuHelpMemory_actionPerformed() {
        ...
        // set the text up.
        JLabel freeMem =
                new JLabel("Free Memory:          " + myFormatter.format(freeMemory / 1024));
        JLabel allocatedMem =
                new JLabel("Allocated Memory:  " + myFormatter.format(allocatedMemory / 1024));
    ...
    public void jMenuHelpHelp_actionPerformed() {
        ...
        for (int type = 0; type < typeamount; type++) {
            ...
            for (int weight = 0; weight < 4; weight++) {
                ...
                result.append(
                        "</td><td>"
                                + CUnit.getInfluenceForUnit(mwclient, weight, type, p.getMyHouse())
                                + "</td>");
                result.append(
                        "<td>"
                                + CUnit.getPPForUnit(mwclient, weight, type, p.getMyHouse())
                                + "</td><td>");
        ...
        for (int type = 0; type < typeamount; type++) {
            for (int weight = 0; weight < 4; weight++) {
                ...
                int repodComponentsInt =
                        Integer.parseInt(mwclient.getServerConfigs(repodComponents));
        ...
        result.append(
                "<tr><td>Light</td><td>"
                        + mwclient.getServerConfigs("MinEXPforLight")
                        + "</td></tr>"); // @salient
        result.append(
                "<tr><td>Medium</td><td>"
                        + mwclient.getServerConfigs("MinEXPforMedium")
                        + "</td></tr>");
        result.append(
                "<tr><td>Heavy</td><td>"
                        + mwclient.getServerConfigs("MinEXPforHeavy")
                        + "</td></tr>");
        result.append(
                "<tr><td>Assault</td><td>"
                        + mwclient.getServerConfigs("MinEXPforAssault")
                        + "</td></tr>");
        result.append("</table>");
        result.append(
                "EXP needed to Buy/Sell on the Black Market: "
                        + mwclient.getServerConfigs("MinEXPforBMBuying")
                        + "/"
                        + mwclient.getServerConfigs("MinEXPforBMSelling")
                        + "<br>");
        result.append(
                "EXP needed to defect from "
        ...
        result.append(
                "<tr><td><img src=\"data/images/status/armor.gif\"></td><td>Unit has armor damage</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/structure.gif\"></td><td>Unit has IS damage</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/critical.gif\"></td><td>Unit has criticals damaged</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/engine.gif\"></td><td>Unit is engined</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/nopilot.gif\"></td><td>Unit has no pilot</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/pilot.gif\"></td><td>Unit has a pilot</td></tr>");
        result.append(
                "<tr><td><img src=\"data/images/status/wound.gif\"></td><td>Unit has a wounded pilot</td></tr>");
        result.append(
        ...
        result.append(
                "<tr><td><img src=\"data/images/status/pending.gif\"></td><td>Unit has pending repairs</td></tr>");
        result.append(
        ...
        result.append(
                "<tr><td><img src=\"data/images/status/maint.gif\"></td><td>Unit is fully maintained</td></tr>");
        result.append(
        ...
        if (mwclient.getData().getServerBannedAmmo().size() > 0) {
            ...
            for (String key : mwclient.getData().getServerBannedAmmo().keySet()) {
                result.append(
                        mwclient.getData().getMunitionsByNumber().get(Long.parseLong(key))
                                + "<br>");
            }
        }
    ...
    private String sPSB(String a, String b) { // BK added
        // builds help menu's pilot skill bv blurb, wants a and b to build serverconfig lookup and
        // get the value
    ...
    public void jMenuHelpPilotSkills_actionPerformed() {
        ...
        if (useAdvanceRepairs) {
            ...
            result +=
                    sPSBL(
                            "Astech",
                            "AT",
                            "Reduces the number of techs needed to repair a unit by 1");
        }
        ...
        result +=
                sPSBL(
                        "Trait",
                        "TN",
                        "Pilot traits for use with moding the gaining of other skills.");
        ...
        if (mwclient.getConfig().isParam("STATUSINTRAYICON")) {
            if (status == MWClient.STATUS_RESERVE) {
                ...
                try {
                    ...
                    || (status == MWClient.STATUS_DISCONNECTED)) {
                try {
    ...
    public void createArmyFromMul(String data) {
        PlayerNameDialog playerDialog =
                new PlayerNameDialog(mwclient, "Choose a Player.", PlayerNameDialog.ANY_PLAYER);
        playerDialog.setVisible(true);
    ...
    public void jMenuSendAllOperationFiles_actionPerformed(ActionEvent e) {
        ...
        int result =
                JOptionPane.showConfirmDialog(
                        null, "Upload All local OpFiles?", "Upload Ops", JOptionPane.YES_NO_OPTION);
        ...
        for (File opFile : opFiles.listFiles()) {
            ...
            mwclient.sendChat(
                    GameHost.CAMPAIGN_PREFIX + "c setoperation#short#" + opData.toString());
            opData.setLength(0);
            opData.trimToSize();
        }
    }
    ...
    public void jMenuSetNewOperationFile_actionPerformed(ActionEvent e) {
        ...
        String opName =
                JOptionPane.showInputDialog(
                        mwclient.getMainFrame().getContentPane(), "New Op Name?");
    ...
    public void jMenuRetrieveOperationFile_actionPerformed(ActionEvent e) {
        JComboBox<String> opCombo =
                new JComboBox<String>(mwclient.getAllOps().keySet().toArray(new String[0]));
        opCombo.setEditable(false);

        JOptionPane jop =
                new JOptionPane(
                        opCombo, JOptionPane.QUESTION_MESSAGE, JOptionPane.OK_CANCEL_OPTION);
    ...
    public void jMenuSetOperationFile_actionPerformed(ActionEvent e) {
        ...
        JComboBox<String> opCombo =
                new JComboBox<String>(
                        mwclient.getAllOps()
                                .keySet()
                                .toArray(new String[mwclient.getAllOps().keySet().size()]));
        opCombo.setEditable(false);
