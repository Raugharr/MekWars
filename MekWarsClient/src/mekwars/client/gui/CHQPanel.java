...
public class CHQPanel extends JPanel {
    ...
    /**
     * Public call which reinitializes the HQ panel. Hacky and evil, but lets camo and # columns in
    ...
    public void refresh() {
        ...
        tblMeks.setPreferredSize(
                new Dimension(
                        tblMeks.getWidth(), tblMeks.getRowHeight() * (MekTable.getRowCount())));
        tblMeks.revalidate();
    ...
    private void btnRemoveAllArmiesActionPerformed(ActionEvent evt) {
        ...
        if (result == JOptionPane.NO_OPTION) return; // Baruk Khazad! 20151204 - end block 1
            ...
            if (result == JOptionPane.YES_OPTION) {
                for (CUnit unit : mwclient.getPlayer().getHangar()) {
                    if (!UnitUtils.hasAllAmmo(unit.getEntity())) {
                        mwclient.sendChat(
                                GameHost.CAMPAIGN_PREFIX + "c RELOADALLAMMO#" + unit.getId());
                    }
                }
    ...
    private void btnAddLanceActionPerformed(ActionEvent evt) {
        mwclient.sendChat(
                GameHost.CAMPAIGN_PREFIX + "c cra#" + mwclient.getConfigParam("DEFAULTARMYNAME"));
    }
    ...
    private void setCamoButtonActionPerformed(ActionEvent evt) {
        ...
        if (camoDialog.showDialog().isConfirmed()) {
            ...
            mwclient.getConfig()
                    .setParam("UNITCAMO", selectedItem.getCategory() + selectedItem.getFilename());
    ...
    public void makeButtons() {
        ...
        btnRemoveAllArmies.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
        ...
        if (useAdvanceRepairs) {
            ...
            repairAllUnitsButton.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent evt) {
            ...
            reloadAllUnitsButton.addActionListener(
                    new ActionListener() {
                        public void actionPerformed(ActionEvent evt) {
        ...
        setCamoButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
        ...
        if (player != null) {
            if (player.getMyHouse()
                ...
                solFreeBuildButton.addActionListener(
                        new ActionListener() {
                            public void actionPerformed(ActionEvent evt) {
    ...
    class MechTableMouseAdapter extends MouseInputAdapter implements ActionListener {
        ...
        public MechTableMouseAdapter() {
            ...
            Image exchangeI =
                    Toolkit.getDefaultToolkit().createImage("./data/images/hqexchange.gif");
            Image positionI =
                    Toolkit.getDefaultToolkit().createImage("./data/images/hqposition.gif");
            Image notallowedI =
                    Toolkit.getDefaultToolkit().createImage("./data/images/hqnotallowed.gif");
            ...
            addCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(plusI, new Point(0, 0), "addcursor");
            removeCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(minusI, new Point(0, 0), "removecursor");
            exchangeCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(exchangeI, new Point(0, 0), "exchangecursor");
            positionCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(positionI, new Point(0, 0), "positioncursor");
            notAllowedCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(notallowedI, new Point(0, 0), "noallowedcursor");
            dupeCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(dupeI, new Point(0, 0), "dupecursor");
            maxCursor =
                    Toolkit.getDefaultToolkit()
                            .createCustomCursor(maxI, new Point(0, 0), "maxcursor");
        }
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if ((dragUnit != null) && (e.getButton() == MouseEvent.BUTTON1)) {
                ...
                MechInfo unitImage =
                        (MechInfo)
                                tblMeks.getCellRenderer(row, col)
                                        .getTableCellRendererComponent(
                                                tblMeks, null, false, false, row, col);
                ...
                dragImage =
                        Toolkit.getDefaultToolkit()
                                .createImage(
                                        new FilteredImageSource(dragImage.getSource(), aFilter));
            }
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (isDrag) {
                ...
                g.drawImage(
                        dragImage,
                        AffineTransform.getTranslateInstance(dragRect.getX(), dragRect.getY()),
                        null);
                ...
                // currArmy exists
                    ...
                    if (startArmy == null) {
                        ...
                        if (mwclient.getMyStatus() != MWClient.STATUS_RESERVE) {
                            tblMeks.setCursor(notAllowedCursor);
                                ...
                                >= Integer.parseInt(
                                        mwclient.getServerConfigs("UnitsInMultipleArmiesAmount"))) {
                    ...
                    // within the same army, change positions
                        ...
                        if ((currUnit != null)
                                ...
                                && (mwclient.getMyStatus() != MWClient.STATUS_FIGHTING)) {
        ...
        /**
         * Private method called on click and release. Checks to see if if mouse event should open a
         * contextual menu (right click, OS X control+click, etc) and shows a popup menu if
         * appropriate.
         */
                ...
                if ((col == 0) && (row >= MekTable.getRowsForArmies())) {
                    ...
                    if (l != null) {
                        ...
                        if (l.getBV() > 0) {
                            ...
                            menuItem.addActionListener(this);
                            boolean canCheckFromReserve =
                                    Boolean.parseBoolean(
                                            mwclient.getServerConfigs("ProbeInReserve"));
                            ...
                            boolean limitsAllowed =
                                    Boolean.parseBoolean(
                                            mwclient.getServerConfigs("AllowLimiters"));
                            if (limitsAllowed) {
                            ...
                            if (Boolean.parseBoolean(
                                    mwclient.getServerConfigs("UseOperationsRule"))) {
                        ...
                        for (int i = 0; i < choices.length; i++) {
                            ...
                            menuName = choices[i];
                            if (mwclient.getConfigParam("PRIMARYARMYSORTORDER")
                    ...
                    if ((mwclient.getPlayer().getHangar().size() > 0) && !l.isLocked()) {
                        ...
                        if (mechArray.length > 0) {
                            Vector<Vector<JMenuItem>> SubMenus =
                                    new Vector<Vector<JMenuItem>>(1, 1);
                    ...
                    if (cm != null) {
                        ...
                        if ((l.getUnits().size() > 0) && !l.isLocked()) {
                            ...
                            while (c3M.hasMoreElements()) {
                                ...
                                if (cm.getC3Level() != Unit.C3_IMPROVED) {
                                    ...
                                    if ((c3Unit.getC3Level() == Unit.C3_IMPROVED)
                                            && c3Unit.checkC3iNetworkHasOpen(l)) {
                                        Masters.add(c3Unit);
                                    }
                                }
                            }
                        ...
                        if (l.isCommander(cm.getId())) {
                            ...
                            menuItem.setActionCommand(
                                    "REMOVEUNITCOMMANDER|" + row + "|" + col + "|" + lid);
                            menuItem.addActionListener(this);
                            popup.add(menuItem);
                        } else {
                            menuItem = new JMenuItem("Set Commander");
                            menuItem.setActionCommand(
                                    "SETUNITCOMMANDER|" + row + "|" + col + "|" + lid);
                            menuItem.addActionListener(this);
                            popup.add(menuItem);
                        }
                    ...
                    if (cm != null) {
                        ...
                        if (useAdvanceRepairs) {
                            ...
                            if (UnitUtils.hasArmorDamage(cm.getEntity())
                                ...
                                if (!Boolean.parseBoolean(
                                        mwclient.getServerConfigs("UseSimpleRepair"))) {
                            ...
                            if (((mwclient.getRMT() != null)
                                    ...
                                    || ((mwclient.getSMT() != null)
                                            && mwclient.getSMT().hasQueuedOrders(cm.getId()))) {
                        ...
                        if (!cm.isChristmasUnit()
                                || Boolean.parseBoolean(
                                        mwclient.getServerConfigs("Christmas_AllowDonate"))) {
                        ...
                        if (!cm.isChristmasUnit()
                                || Boolean.parseBoolean(
                                        mwclient.getServerConfigs("Christmas_AllowScrap"))) {
                        ...
                        if (Player.getHouse()
                                ...
                                && Boolean.parseBoolean(
                                        mwclient.getServerConfigs("Sol_FreeBuild"))) {
                        ...
                        if (!cm.isChristmasUnit()
                                || Boolean.parseBoolean(
                                        mwclient.getServerConfigs("Christmas_AllowTransfer"))) {
                        ...
                        if (cm.isChristmasUnit()
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("Christmas_AllowBM"))) {
                            canSellUnit = false;
                        }
                        if ((cm.getType() == Unit.MEK)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("MeksMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        } else if ((cm.getType() == Unit.VEHICLE)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("VehsMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        } else if ((cm.getType() == Unit.BATTLEARMOR)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("BAMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        } else if ((cm.getType() == Unit.AERO)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("AerosMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        } else if ((cm.getType() == Unit.PROTOMEK)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("ProtosMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        } else if ((cm.getType() == Unit.INFANTRY)
                                && !Boolean.parseBoolean(
                                        mwclient.getServerConfigs("InfantryMayBeSoldOnBM"))) {
                            canSellUnit = false;
                        ...
                        StringTokenizer blockedFactions =
                                new StringTokenizer(mwclient.getServerConfigs("BMNoSell"), "$");
                        ...
                        if (!cm.hasVacantPilot()) {
                            ...
                            pm.add(menuItem);
                            if (Boolean.parseBoolean(
                                    mwclient.getServerConfigs("PlayersCanBuyPilotUpgrades"))) {
                                menuItem = new JMenuItem("Promote Pilot");
                                menuItem.setActionCommand("PP|" + cm.getId());
                                menuItem.addActionListener(this);
                                pm.add(menuItem);
                                if (Boolean.parseBoolean(
                                        mwclient.getServerConfigs("PlayersCanSellPilotUpgrades"))) {
                        ...
                        boolean ppqsEnabled =
                                Boolean.parseBoolean(
                                        mwclient.getServerConfigs("AllowPersonalPilotQueues"));
                        if (ppqsEnabled && (cm.isSinglePilotUnit())) {

                            // load possible pilots
                            Object[] pilots =
                                    Player.getPersonalPilotQueue()
                        ...
                        int hangernum =
                                (((row - MekTable.getRowsForArmies())
                                                        * (MekTable.getColumnCount() - 1))
                                                + col)
                                        - 1;
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            if (command.equalsIgnoreCase("EXM")) {
                ...
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "c EXM#" + lid + "," + mid + "#" + hid);
                // move to hanger
                ...
                boolean useForceSize =
                        Boolean.parseBoolean(mwclient.getServerConfigs("UseOperationsRule"));
                ...
                theEntity.loadAllWeapons();
                CustomUnitDialog customizeUnit =
                        new CustomUnitDialog(mwclient, theEntity, mek.getPilot(), mek);
                ...
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "c DisplayUnitRepairJobs#" + mek.getId());
            ...
            // Estimate Unit Repairs
                ...
                if (Boolean.parseBoolean(mwclient.getServerConfigs("UseRealRepairCosts"))) {
                    ...
                    repairCost *=
                            Double.parseDouble(mwclient.getServerConfigs("RealRepairCostMod"));
                    greenTechCost =
                            mwclient.getTechLaborCosts(mek.getEntity(), UnitUtils.TECH_GREEN);
                    ...
                    eliteTechCost =
                            mwclient.getTechLaborCosts(mek.getEntity(), UnitUtils.TECH_ELITE);

                    mwclient.systemMessage(
                            "It'll cost you at least the following to repair your "
                                    + mek.getModelName()
                                    + ".<br><table>"
                                    + "<tr><th>Green Tech:</th><th>"
                                    + mwclient.moneyOrFluMessage(
                                            true, true, (int) repairCost, false)
                                    + " in parts and "
                                    + mwclient.moneyOrFluMessage(true, true, greenTechCost, false)
                                    + " in labor for a total of "
                                    + mwclient.moneyOrFluMessage(
                                            true, true, (int) repairCost + greenTechCost, false)
                                    + ".</th></tr>"
                                    ...
                                    + " in labor for a total of "
                                    + mwclient.moneyOrFluMessage(
                                            true, true, (int) repairCost + regTechCost, false)
                                    + ".</th></tr>"
                                    ...
                                    + " in labor for a total of "
                                    + mwclient.moneyOrFluMessage(
                                            true, true, (int) repairCost + vetTechCost, false)
                                    + ".</th></tr>"
                                    ...
                                    + " in labor for a total of "
                                    + mwclient.moneyOrFluMessage(
                                            true, true, (int) repairCost + eliteTechCost, false)
                                    + ".</th></tr></table>");
                } else {
                ...
                for (CArmy currA : mwclient.getPlayer().getArmies()) {
                    if (currA.getUnit(mid) != null) {
                        mwclient.sendChat(
                                GameHost.CAMPAIGN_PREFIX + "c EXM#" + currA.getID() + "," + mid);
                    }
                }
                ...
                for (CBMUnit currU : marketUnits.values()) {
                    if (currU.getUnitID() == mid) {
                        mwclient.sendChat(
                                GameHost.CAMPAIGN_PREFIX + "c recall#" + currU.getAuctionID());
                        break;
                    }
                }
                // direct sell unit
                ...
                int num = Integer.parseInt(st.nextToken());
                // int result = JOptionPane.showConfirmDialog(mwclient.getMainFrame(), "Are you sure
                // you want to Remove this unit?", "Delete it?", JOptionPane.YES_NO_OPTION);
                ...
                int hid = Integer.parseInt(st.nextToken());
                mwclient.sendChat(
                        GameHost.CAMPAIGN_PREFIX + "c linkunit#" + lid + "#" + mid + "#" + hid);
    ...
    public class MekTableModel extends AbstractTableModel {
        ...
        public int getRowsForArmy(CArmy army) {
            int toReturn =
                    (int)
                            Math.ceil(
                                    (double) army.getAmountOfUnits()
                                            / (double) (getColumnCount() - 1));
            if (toReturn < 1) {
                return 1;
            }
            return toReturn;
        ...
        public int getRowsForHangar() {
            ...
            return (int)
                    Math.ceil(
                            (double) (freebays + Player.getHangar().size())
                                    / (getColumnCount() - 1));
        }
        ...
        public Object getValueAt(int row, int col) {
            ...
            if (col == 0) {
                ...
                if (row < getRowsForArmies()) {
                    ...
                    boolean limitsAllowed =
                            Boolean.parseBoolean(mwclient.getServerConfigs("AllowLimiters"));
                    if (limitsAllowed) {
                        ...
                        if ((army.getLowerLimiter() == Army.NO_LIMIT)
                                && (army.getUpperLimiter() == Army.NO_LIMIT)) {
                            range = "No Limits";
                        }
                    }
            ...
            public Component getTableCellRendererComponent(
                ...
                if (cm != null) {
                    ...
                    if (mwclient.getPlayer().getMyHouse().getNonFactionUnitsCostMore()) {
                        ...
                        int numTechs =
                                (int)
                                        (Integer.parseInt(mwclient.getServerConfigs(techAmount))
                                                * (mwclient.getPlayer()
                                                                .getMyHouse()
                                                                .houseSupportsUnit(
                                                                        cm.getUnitFilename())
                    ...
                    if (Boolean.parseBoolean(
                            mwclient.getConfig().getParam("EXPANDEDUNITTOOLTIP"))) {
                        ...
                        if (jump != 0) C3Text.append("/" + jump + "<br>");
                        else C3Text.append("<br>");

                        C3Text.append(
                                "Heat Capacity: " + cm.getEntity().getHeatCapacity() + "<br>");

                        //                        if(cm.getEntity().hasQuirk("no_twist"))
                        //                            C3Text.append("Torso Twist: <font
                        // color=\"green\">NO</font><br>");
                        //                        else
                        //                            C3Text.append("Torso Twist: <font
                        // color=\"red\">YES</font><br>");
                    ...
                    if (cm.getStatus() == Unit.STATUS_FORSALE) {
                        ...
                        // Unit.STATUS_UNMAINTAINED) {
                        //                            // a nice rusty orange for unmaintained units
                        //                            c.setBackground(new Color(190, 150, 55));
                        //                        }
                        // @salient, isnt this the same as the first if statement? duplicate
                        // condition.
