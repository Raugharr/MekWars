...
class MMNetHyperLinkListener implements HyperlinkListener {
     ...
     *
     * @return The URL value if mouse is currently hovering over a URL, or <code>null</code> if not
     *     currently hovering over a URL
     */
            ...
            if (e instanceof HTMLFrameHyperlinkEvent) {
                ...
                try {
                    ...
                    if (e.getDescription().startsWith("MEKWARS")) {
                        ...
                        // fetch the map
                        InnerStellarMap map =
                                mwclient.getMainFrame().getMainPanel().getMapPanel().getMap();
                        ...
                        if (confirmed == JOptionPane.OK_OPTION) mwclient.sendChat(command);
