    ...
    public boolean execute(String input) {
        ...
        if (check(ST.nextToken())) {
            ...
            if (mwclient.getConfig().isParam("USEMULTIPLEPM")) {
                ...
                if (mwclient.getMainFrame().getMainPanel().getCommPanel().findMailTab(receiver)
                        == null) {
                    int count =
                            mwclient.getMainFrame().getMainPanel().getCommPanel().countMailTabs();
        ...
        */
        ...
        if (colorSetting.equals("factionadd") || colorSetting.equals("factionall")) {
            ...
            addon =
                    addon.equals("")
                            ? ""
                            : " <b><font color=\"" + usercolor + "\">[" + addon + "]</b></font>";
        }
        ...
        if (colorSetting.equals("factionname") || colorSetting.equals("factionall")) {
            name =
                    name.equals("")
                            ? ""
                            : " <b><font color=\"" + factioncolor + "\">" + name + "</b></font>";
        } else {
            name =
                    name.equals("")
                            ? ""
                            : " <b><font color=\"" + usercolor + "\">" + name + "</b></font>";
        }
        ...
        if (Config.isParam("TIMESTAMP")) message = mwclient.getShortTime() + message;
        ...
        if (Config.isParam("MAINCHANNELPM")) {
            String sysColour = mwclient.getConfigParam("SYSMESSAGECOLOR");
            mwclient.addToChat(
                    "<font color=\"" + sysColour + "\"><b>Private Mail: </b></font>" + message);
        }
    }
