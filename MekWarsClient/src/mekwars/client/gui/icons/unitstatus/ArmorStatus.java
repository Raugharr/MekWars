...
public class ArmorStatus implements UnitStatus {
    private static final int STRUCTURE = 0;
    private static final int ARMOR = 1;

    private static final UnitStatusIcon[] ICONS = new UnitStatusIcon[] {
        new UnitStatusIcon("data/images/status/structure.gif") {
            @Override
            public String getToolTipText(ResourceBundle resourceBundle) {
                return resourceBundle.getString("unitStatus.structure.tooltip");
            }
        },
        new UnitStatusIcon("data/images/status/armor.gif") {
            @Override
            public String getToolTipText(ResourceBundle resourceBundle) {
                return resourceBundle.getString("unitStatus.armor.tooltip");
            }
        },
    };
