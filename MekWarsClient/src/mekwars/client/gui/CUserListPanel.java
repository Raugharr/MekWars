...
public class CUserListPanel extends JPanel implements ActionListener {
    ...
    public CUserListPanel(MWClient client) {
        ...
        if (mode.equals("HOUSE")) {
            ((CUserListModel) UserList.getModel()).setSortMode(SORTMODE_HOUSE);
        } else if (mode.equals("EXP")) {
            ((CUserListModel) UserList.getModel()).setSortMode(SORTMODE_EXP);
            ...
            ((CUserListModel) UserList.getModel()).setSortMode(SORTMODE_STATUS);
        } else if (mode.equals("USERLEVEL")) {
            ((CUserListModel) UserList.getModel()).setSortMode(SORTMODE_USERLEVEL);
        } else if (mode.equals("COUNTRY")) {
            ((CUserListModel) UserList.getModel()).setSortMode(SORTMODE_COUNTRY);
        } else {
        ...
        if (order.equals("DESCENDING")) {
            ((CUserListModel) UserList.getModel()).setSortOrder(SORTORDER_DESCENDING);
        } else {
            ((CUserListModel) UserList.getModel()).setSortOrder(SORTORDER_ASCENDING);
        }
    }
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                            try {
                                desktop.browse(
                                        new URL(mwclient.getServerConfigs("Link1_URL")).toURI());
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                            try {
                                desktop.browse(
                                        new URL(mwclient.getServerConfigs("Link2_URL")).toURI());
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
                            try {
                                desktop.browse(
                                        new URL(mwclient.getServerConfigs("Link3_URL")).toURI());
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
     ...
     *
     * <p>If ActivityButton is pressed, look at Client's current login/activity status and act
     * accordingly.
     */
    ...
    class UserListPopupListener extends MouseAdapter implements ActionListener {
        ...
        private void maybeShowPopup(MouseEvent e) {
            ...
            if (e.isPopupTrigger()) {
                ...
                if (row > -1 && row < UserList.getModel().getSize()) {
                     ...
                     */
                    if (mwclient.isMod()) {
                        StaffUserlistPopupMenu staffUserlistPopupMenu =
                                new StaffUserlistPopupMenu();
                    ...
                    if (!userName.equalsIgnoreCase(mwclient.getPlayer().getName())) {
                        ...
                        if (LoggedIn && user.getStatus() != MWClient.STATUS_LOGGEDOUT) {
                            ...
                            item =
                                    new JMenuItem(
                                            "Send " + mwclient.moneyOrFluMessage(true, false, -2));
                        ...
                        if (Integer.parseInt(mwclient.getServerConfigs("NoPlayListSize")) >= 1) {
                            ...
                            if (LoggedIn && user.getStatus() != MWClient.STATUS_LOGGEDOUT) {
                                ...
                                if (mwclient.getPlayer()
                                        .getAdminExcludes()
                                        .contains(userName.toLowerCase())) isOnNoPlay = true;
                                else if (mwclient.getPlayer()
                                        .getPlayerExcludes()
                                        .contains(userName.toLowerCase())) isOnNoPlay = true;
                    ...
                    if (((CUserListModel) UserList.getModel()).getSortOrder()
                    ...
                    if (mwclient.getConfig().isParam("USERLISTACTIVITYBTN")) item.setSelected(true);
                    ...
                    if (mwclient.getConfig().isParam("USERLISTBOLD")) item.setSelected(true);
                    else item.setSelected(false);
                    ...
                    if (mwclient.getConfig().isParam("USERLISTCOLOR")) item.setSelected(true);
                    else item.setSelected(false);
                    ...
                    if (Dedicateds) item.setSelected(true);
                    else item.setSelected(false);
                    ...
                    if (mwclient.getConfig().isParam("USERLISTCOUNT")) item.setSelected(true);
                    else item.setSelected(false);
                    ...
                    if (mwclient.getConfig().isParam("USERLISTIMAGE")) item.setSelected(true);
                    else item.setSelected(false);
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            if (command.equals("MR") && st.hasMoreElements()) {
                userName = st.nextToken();
                mwclient.getMainFrame()
                        .jMenuCommanderTransferRewardPoints_actionPerformed(userName);
                return;
            }
            ...
            if (command.equals("TU") && st.hasMoreElements()) {
                ...
                if (true)
                    mwclient.getMainFrame()
                            .jMenuCommanderTransferUnit_actionPerformed(userName, -1);
                return;
            }
            ...
            if (command.equals("DSU") && st.hasMoreElements()) {
                ...
                if (true)
                    mwclient.getMainFrame()
                            .jMenuCommanderDirectSell_actionPerformed(userName, null);
                return;
            }
            ...
            if (command.equals("SM") && st.hasMoreElements()) {
                ...
                // saveblock
                if (command.equals("H")) {
                    mwclient.getConfig().setParam("SORTMODE", "HOUSE");
                } else if (command.equals("E")) {
                    mwclient.getConfig().setParam("SORTMODE", "EXP");
                } else if (command.equals("R")) {
                    ...
                    mwclient.getConfig().setParam("SORTMODE", "COUNTRY");
                } else {
            ...
            if (command.equals("SO") && st.hasMoreElements()) {
                ...
                // saveblock
                if (command.equals("D")) {
                    mwclient.getConfig().setParam("SORTORDER", "DESCENDING");
                } else {
            ...
            if (command.equals("TD")) {
                ...
                if (Dedicateds) {
                    mwclient.getConfig().setParam("USERLISTDEDICATEDS", "YES");
                } else {
    ...
    public static class CUserListModel extends AbstractListModel {
        ...
        public synchronized void addAll(Collection<CUser> c) {
            Users.addAll(c);
        }
        ...
        static class UserListCellRenderer extends JLabel implements ListCellRenderer {
            ...
            public Component getListCellRendererComponent(
                ...
                if (userlevel >= 30 && userlevel < 100) {
                    setText("^" + invisFlag + user.getName());
                }
                ...
                if (ulMwclient
                        .getPlayer()
                        .getAdminExcludes()
                        .contains(user.getName().toLowerCase())) isOnNoPlay = true;
                else if (ulMwclient
                        .getPlayer()
                        .getPlayerExcludes()
                        .contains(user.getName().toLowerCase())) isOnNoPlay = true;
                ...
                if (isMuted > 0 && isOnNoPlay) setText(getText() + " [muted" + muteUps + ", np]");
                else if (isMuted > 0) setText(getText() + " [muted" + muteUps + "]");
                else if (isOnNoPlay) setText(getText() + " [np]");
        ...
        public class UserComparator implements Comparator<CUser> {
            ...
            public int compare(CUser o1, CUser o2) {
                ...
                if (Mode == SORTMODE_NAME) {
                    return (user1.getName().compareToIgnoreCase(user2.getName()));
                }
                if (Mode == SORTMODE_HOUSE) {
                    result = user1.getHouse().compareToIgnoreCase(user2.getHouse());
                }
                if (Mode == SORTMODE_COUNTRY) {
            ...
            public void setMode(int tmode) {
                if (tmode == SORTMODE_NAME
                        || tmode == SORTMODE_HOUSE
                        || tmode == SORTMODE_EXP
                        || tmode == SORTMODE_RATING
                        || tmode == SORTMODE_STATUS
                        || tmode == SORTMODE_USERLEVEL
...
class ActivationThread extends Thread {
    ...
    public ActivationThread(
            MWClient mwclient, JButton activityButton, Icon flash, Icon end, Icon roll) {
        ;
