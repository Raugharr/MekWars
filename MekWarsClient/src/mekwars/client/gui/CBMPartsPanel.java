...
public class CBMPartsPanel extends JPanel {
                        ...
                        String part =
                                (String)
                                        tblMarket
                                                .getModel()
                                                .getValueAt(
                                                        selectedRow, BlackMarketPartsModel.PART);
                        if (part != null) {
    ...
    public BMEquipment getPartsAtRow(int row) {
        bme = null;
        String part =
                (String) tblMarket.getModel().getValueAt(row, BlackMarketPartsModel.INTERNALPART);
                    ...
                    JOptionPane.showMessageDialog(
                            ...
                            "You only have "
                                    + mwclient.moneyOrFluMessage(
                                            true, true, mwclient.getPlayer().getMoney()));
                    return;
                }
