...
public class MekInfo extends JPanel {
    ...
    /**
     * Creates new MekInfo for use in previews. Is passed a ficticious config
    ...
    private class EntityImage {
        ...
        private Image applyColor(Image image) {
            ...
            PixelGrabber pgMek = new PixelGrabber(iMek, 0, 0, IMG_WIDTH, IMG_HEIGHT, pMek, 0, IMG_WIDTH);
            ...
            image = comp.createImage(new MemoryImageSource(IMG_WIDTH, IMG_HEIGHT, pMek, 0, IMG_WIDTH));
            return image;
        }
    }
