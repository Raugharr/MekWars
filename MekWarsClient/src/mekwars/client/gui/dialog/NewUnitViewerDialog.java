...
public class NewUnitViewerDialog extends JDialog implements Runnable, KeyListener, ActionListener {
    ...
    public NewUnitViewerDialog(JFrame mainFrame, UnitLoadingDialog uld, MWClient c, int viewer) {
        ...
        asd =
                new AdvancedSearchDialog(
                        mainFrame, Integer.parseInt(client.getServerConfigs("CampaignYear")));
    }
    ...
    private void initComponents() {
        ...
        splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, selectionPanel, panelMekView);
    ...
    void filterUnits() {
        ...
        try {
            unitTypeFilter =
                    new RowFilter<MechTableModel, Integer>() {
                        @Override
                        public boolean include(
                            ...
                            if (
                            /* Weight */
                            ((nClass == EntityWeightClass.SIZE)
                                            || (mech.getWeightClass() == nClass))
                                    &&
                                    /*Canon*/
                                    (!mmClient.getGame().getOptions().booleanOption("canon_only")
                                            || mech.isCanon())
                                    &&
                                    /*Technology Level*/
                                    ...
                                    && ((nUnit == -1)
                                            || mech.getUnitType()
                                                    .equals(UnitType.getTypeName(nUnit)))
                                    /*Advanced Search*/
                                    && ((searchFilter == null)
                                            || MechSearchFilter.isMatch(mech, searchFilter))
                                    && !(mech.getYear()
                                            > Integer.parseInt(
                                                    client.getServerConfigs("CampaignYear")))) {
    ...
    public void keyPressed(KeyEvent ke) {
        if (ke.getKeyCode() == KeyEvent.VK_ENTER) {
            ActionEvent event =
                    new ActionEvent(btnSelect, ActionEvent.ACTION_PERFORMED, ""); // $NON-NLS-1$
    ...
    public void actionPerformed(ActionEvent ev) {
        if (ev.getSource().equals(comboType)
            ...
            JOptionPane.showMessageDialog(
                    null, tScroll, "BV", JOptionPane.INFORMATION_MESSAGE, null);
            ...
            if (viewerType == NewUnitViewerDialog.OMNI_VARIANT_SELECTOR) {
                try {
                    ...
                    String moneyMod =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Money Mod for " + unit, 0);
                    ...
                    String compMod =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Comp Mod for " + unit, 0);
                    ...
                    String fluMod =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Flu Mod for " + unit, 0);
                ...
                try {
                    ...
                    String fluff =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Fluff text for " + unit);
                    ...
                    String gunnery =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Gunnery skill for " + unit, 99);
                    ...
                    String piloting =
                            JOptionPane.showInputDialog(
                                    client.getMainFrame(), "Piloting Mod for " + unit, 99);
    ...
    private void saveComboBoxSettings() {
        ...
        //            client.getConfig().setParam("UNITVIEWERSORT", (String)
        // combos.getSelectedItem());
        //            if (mechList.getSelectedValue() != null) {
        //                client.getConfig().setParam("UNITVIEWERUNIT",
        // mechList.getSelectedValue().toString());
        //            }
