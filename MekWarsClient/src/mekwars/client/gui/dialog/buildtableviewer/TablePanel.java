...
public class TablePanel extends JPanel implements ActionListener {
    ...
    /**
     * Get the tables ready. This currently does not handle anything that does not contain a faction
     * name. For instance, on MMNet, we have a table called Contest_Light.txt. That's a valid table,
     * but the viewer will not currently display it. On the to-do list
     */
