    ...
    public PlanetNameDialog(MWClient mwclient, String boxText, String[] opProps) {
        ...
        if (opProps == null) { // no filtering needed
            ...
            while (i.hasNext()) {
                ...
                if (facInfo.equals("none") && tp.getFactoryCount() > 0) continue;
                else if (facInfo.equals("only") && tp.getFactoryCount() < 1) continue;

                if (tp.isHomeWorld() && homeInfo.equals("none")) continue;
                else if (!tp.isHomeWorld() && homeInfo.equals("only")) continue;
                    ...
                    public void caretUpdate(CaretEvent e) {
                        new Thread() {
                            ...
                            public void run() {
                                ...
                                matchingPlanetsList.setListData(
                                        possiblePlanets.toArray(
                                                new String[possiblePlanets.size()]));
