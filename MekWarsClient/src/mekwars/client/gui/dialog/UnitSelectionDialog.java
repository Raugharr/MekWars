...
public class UnitSelectionDialog extends JDialog implements ActionListener {
    ...
    public UnitSelectionDialog(MWClient mwclient, String boxText, String labelText) {
        ...
        possibleUnits.setModel(
                new DefaultComboBoxModel(mwclient.getPlayer().getHangar()) {
                    /** */
        ...
        newDim.setSize(
                possibleUnits.getMinimumSize().getWidth() * 1.25,
                possibleUnits.getMinimumSize().getHeight());
