...
public class HouseNameDialog extends JDialog implements ActionListener {
    ...
    // constructor
    public HouseNameDialog(
            MWClient mwclient, String boxText, boolean addblank, boolean showCanDefectTo) {
                    ...
                    public void caretUpdate(CaretEvent e) {
                        new Thread() {
                            ...
                            public void run() {
                                ...
                                for (Iterator<String> it = factionNames.iterator();
                                        it.hasNext(); ) {
                                    String curHouse = it.next();
                                    if (curHouse.toLowerCase().indexOf(text) != -1)
                                        possibleHouses.add(curHouse);
                                }
                                matchingHousesList.setListData(
                                        possibleHouses.toArray(new String[possibleHouses.size()]));
