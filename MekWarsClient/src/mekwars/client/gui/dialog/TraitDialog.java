...
public final class TraitDialog implements ActionListener, KeyListener {
    ...
    public TraitDialog(MWClient c, boolean player) {
        ...
        } else cancelButton.setToolTipText("Exit without saving changes");
        ...
        astechText.setToolTipText(
                "<html>Astech<br>Modifies the chance for a pilot to receive this skill</html>");
        ...
        giftedText.setToolTipText(
                "<html>Gifted<br>Modifies the chance for a pilot to receive this skill</html>");
        ...
        gunneryBalisticText.setToolTipText(
        ...
        ironManText.setToolTipText(
                "<html>Iron Man<br>Modifies the chance for a pilot to receive this skill</html>");
        ...
        medtechText.setToolTipText(
                "<html>Medtech<br>Modifies the chance for a pilot to receive this skill</html>");
        ...
        NAGText.setToolTipText(
                "<html>Natural Aptitiude: Gunnery<br>Modifies the chance for a pilot to receive this skill</html>");
    ...
    private void loadFactionTraits(String faction) {
        File traitFile =
                new File(mwclient.getCacheDir() + "/" + faction.toLowerCase() + "traitnames.txt");
        TreeSet<String> names = new TreeSet<String>();
        ...
        try {
            ...
            for (int i = 0; i < tempArray.length; i++) traitComboBox.addItem(tempArray[i]);
        } catch (Exception ex) {
            ...
            while (dis.ready()) {
                ...
                if (traitName.equalsIgnoreCase(trait)) {
                    while (traitNames.hasMoreTokens()) {
                        ...
                        else if (traitID == PilotSkill.AstechSkillID) astechText.setText(traitMod);
                        ...
                        else if (traitID == PilotSkill.GiftedID) giftedText.setText(traitMod);
