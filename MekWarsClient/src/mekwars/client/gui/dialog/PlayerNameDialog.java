    ...
    public PlayerNameDialog(MWClient client, String boxText, int playerType) {
        ...
        if (playerType == FACTION_ONLY) {
            while (i.hasNext()) {
                ...
                if (user.isInvis()
                        && user.getUserlevel()
                                > client.getUser(client.getPlayer().getName()).getUserlevel())
                    continue;
                if (user.getHouse().equalsIgnoreCase(client.getPlayer().getHouse())
                        && !user.getName().equals(client.getPlayer().getName()))
                    ...
                    public void caretUpdate(CaretEvent e) {
                        new Thread() {
                            ...
                            public void run() {
                                ...
                                matchingPlayersList.setListData(
                                        possiblePlayers.toArray(
                                                new String[possiblePlayers.size()]));
