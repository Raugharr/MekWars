...
/**
 * This class is a scanner generated by <a href="http://www.jflex.de/">JFlex</a> 1.3.5 on 08.01.04
 * 20:53 from the specification file
...
class BrowserCommandLexer {
    ...
    private static final String yycmap_packed =
            "\11\0\2\2\1\0\2\2\22\0\1\2\1\0\1\3\36\0\1\0" + "\32\0\1\1\uffa3\0";

    /** Translates characters to character classes */
    private static final char[] yycmap = yy_unpack_cmap(yycmap_packed);

    /** Translates a state to a row index in the transition table */
    private static final int yy_rowMap[] = {0, 4, 8, 12, 16, 8, 20, 24, 4, 28, 16, 32, 12, 24};
    ...
    private static final byte YY_ATTRIBUTE[] = {1, 1, 1, 9, 1, 0, 0, 0, 1, 1, 1, 0, 9, 1};
    ...
    /* user code: */
    /**
     * Prints out tokens and line numbers from a file or System.in. If no arguments are given,
     * System.in will be used for input. If more arguments are given, the first argument will be
     * used as the name of the file to use as input
     *
     * @param args program arguments, of which the first is a filename
     * @since ostermillerutils 1.00.00
     *     <p>private static void main(String[] args) { InputStream in; try { if (args.length > 0){
     *     File f = new File(args[0]); if (f.exists()){ if (f.canRead()){ in = new
     *     FileInputStream(f); } else { throw new IOException("Could not open " + args[0]); } } else
     *     { throw new IOException("Could not find " + args[0]); } } else { in = System.in; }
     *     BrowserCommandLexer shredder = new BrowserCommandLexer(in); String t; while ((t =
     *     shredder.getNextToken()) != null) { MWLogger.infoLog(t); } } catch (IOException e){
     ...
     *     yylength()!
     *     <p>private void yypushback(int number) { if ( number > yylength() )
     *     yy_ScanError(YY_PUSHBACK_2BIG);
     *     <p>yy_markedPos -= number; }
     */
