...
public class HS extends Command {
    ...
    public void execute(String input) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (cmdName.equals("CA")) return; // return without updating view
        }
    ...
    /**
     * HS| Commands can be issued in bulk. This allows short ops, etc to send ALL changes they make
     * ot impacted house players at once instead of sending 5-10 separate updates.
     */
