...
public class PF extends Command {
     ...
     *     AF|name|id|value to add a flag to both defaults and personal DF|name to delete a flag
     *     from both defaults and personal SF|name|value to set a personal flag SSDF|name|value to
     *     set a new value for a default flag
     */
    @Override
