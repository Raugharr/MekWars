...
/**
 * The keeper of the Socket on the client side. Using deprecated JDK1.0.2 I/O methods on purpose,
 * because this may be running in a crappy browser.
 *
 * <p>This method spawns two threads: One for reading and one for writing. When new messages are
 * read, they are passed to the ChatServerLocal via it's incomingMessage() method
 *
...
public class ConnectionHandlerLocal implements IConnectionHandler {
     ...
     * ChatServerLocal. This method is typically called by the ReaderThread when it has detected the
     * the connection died.
     */
