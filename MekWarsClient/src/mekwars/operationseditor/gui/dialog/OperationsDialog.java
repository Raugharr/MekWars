...
/**
 * @author jtighe
 *     <p>Server Configuration Page. All new Server Options need to be added To this page as well.
 */
...
public class OperationsDialog extends JFrame implements ActionListener, KeyListener, MouseListener {
     ...
     *     <p>I've completely redone how the Operations dialog works There are 2 basic fields now
     *     baseTextField which is a JTextField and baseCheckBox which is a JCheckBox.
     *     <p>When you add a new config add the labels to the tab then use the base fields to add
     *     the ver. make sure to set the base field's name method this is used to populate and save.
     *     <p>ex: BaseTextField.setName("DefaultOperationsOptionsVariable");
     *     <p>Three recursive methods populate, load, and save the data to file
     *     <p>findAndPopulateTextAndCheckBoxes(JPanel) findAndPopulateTextAndCheckBoxes(JPanel,
     *     BackedTreeMap) findAndSaveConfigs(JPanel, PrintStream)
     *     <p>This change to the code removes the tediousness of having to add a new var to 3
     *     locations when it is used. Now only 1 location needs to be added and that is the vars
     *     placement on the tab in the UI.
     */
    ...
    public void jMenuCreateShortOp_actionPerformed(ActionEvent e) {
        taskName =
                JOptionPane.showInputDialog(
                        null, "Operation Name", "New Operation Name", JOptionPane.OK_CANCEL_OPTION);
    ...
    public void createShortOpPanel() {
        ...
        JPanel playerPropertiesPanel =
                new JPanel(); // mins/maxes for players if they can attack/defend an op
        JPanel scenarioPanel =
                new JPanel(); // Arty/mines anything given to an attacker/defender besides their own
        // units
        ...
        JPanel metaSetupPanel =
                new JPanel(); // Set what your faction gets for this op. Land Units Components
        JPanel chickenLeechPanel =
                new JPanel(); // Set up what happens to those that flee and those that don't pay
        // attention to an attack.
        ...
        BaseTextField.setToolTipText(
                "<html>Flags the planet must have to allow this op.<br>Delimit/Sperate with ^ Example AA^BB^CC</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Flags the planet cannot have for this op to be allowed.<br>Delimit/Sperate with ^ Example AA^BB^CC</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>The Max Difference in ELO between the attacker and the defender</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Your SubFactionAcessLevel must be this high to ride.<br>Default 0</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV difference between attacker and defender.<br>Default 150</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>% chance operation will occur at night. Default 0</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>% Chance operation will occur at dusk.  Default 0%</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If checked, attack type may only be used against<br>a world which has a production facility.</html>");
        BaseCheckBox.setName("OnlyAgainstFactoryWorlds");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("May Not Have Fac");
        BaseCheckBox.setToolTipText(
                "<html>If checked, attack type may only be used against<br>a world which has NO production facilities.</html>");
        BaseCheckBox.setName("OnlyAgainstNonFactoryWorlds");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Must Have Home");
        BaseCheckBox.setToolTipText(
                "<html>If checked, attack type may only be used against<br>a world that is set as a homeworld.</html>");
        BaseCheckBox.setName("OnlyAgainstHomeWorlds");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("May Not Have Home");
        BaseCheckBox.setToolTipText(
                "<html>If checked, attack type may only be used against<br>a world which has not been labeled as a homeworld.</html>");
        BaseCheckBox.setName("OnlyAgainstNonHomeWorlds");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Real Blind Drop");
        BaseCheckBox.setToolTipText(
                "<html>If checked the operation will play in<br>real blind drop and double blind mode</html>");
        BaseCheckBox.setName("RealBlindDrop");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Report Op To News Feed");
        BaseCheckBox.setToolTipText(
                "<html>This will send the op info to the servers newsfeed file.</html>");
        BaseCheckBox.setName("ReportOpToNewsFeed");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Doesn't Count Toward PP");
        BaseCheckBox.setToolTipText(
                "<html>Armies that are only legal for this op will not produce components.</html>");
        BaseCheckBox.setName("DoesNotCountForPP");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Forbid Counterattacks");
        BaseCheckBox.setToolTipText(
                "<html>Check to stop players from using this attack if under attack themselves.</html>");
        BaseCheckBox.setName("ForbidCounterAttacks");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("AFR Only");
        BaseCheckBox.setToolTipText(
                "Check to stop players on active duty from using this attack (AFR only).");
        BaseCheckBox.setName("OnlyAllowedFromReserve");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Active Only");
        BaseCheckBox.setToolTipText(
                "Check to stop players on reserve duty from using this attack (No AFR).");
        BaseCheckBox.setName("OnlyAllowedFromActive");
        rangesBox2.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Debug Op");
        BaseCheckBox.setToolTipText(
                "<html>This will help send debug message to the Error logs for ops to debug ops.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Factions which may use this attack. Separate with $'s<br>Example: Liao$Davion$<br>Only add $ if you have more then one faction listed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Factions which may NOT use this attack. Separate with $'s.<br>Only used if Legal is blank.<br>Example: Pirates$Bandits<br>Only add $ if you have more then one faction listed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Factions which may defend against this attack. Separate with $'s<br>Example: Marik$Kurita$Steiner<br>Only add $ if you have more then one faction listed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Factions which may NOT defend this attack. Separate with $'s.<br>Only used if Legal is blank.<br>Example: Solaris Training Company$Periphery<br>Only add $ if you have more then one faction listed.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "If true, vehicles are included when checking BV spreads between high/low units.");
        BaseCheckBox.setName("CountVehsForSpread");
        spreadPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Count Aeros in Spread");
        BaseCheckBox.setToolTipText(
                "If true, aeros are included when checking BV spreads between high/low units.");
        BaseCheckBox.setName("CountAerosForSpread");
        spreadPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Count Protos in Spread");
        BaseCheckBox.setToolTipText(
                "If true, protos are included when checking BV spreads between high/low units.");
        BaseCheckBox.setName("CountProtosForSpread");
        spreadPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Count Inf in Spread");
        BaseCheckBox.setToolTipText(
                "If true, infantry and BA are included when checking BV spreads between high/low units.");
        BaseCheckBox.setName("CountInfForSpread");
        spreadPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Ignore pilot for BV Spread");
        BaseCheckBox.setToolTipText(
                "If true, pilot levels will be ignored for the purposes of spread-checking");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If true, support units will be counted as normal units for purposes of unit count.<br>If false, a support unit will not count towards it unit type count.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Overrides Allow Infantry and allows foot/moto/jump units.<br>Set inf allowed to False and this to True to BA/Protos<br>but allow foot/jump/moto inf.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of Non-Infantry in the attackers army<br>Includes Meks and Vehicles</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of Non-Infantry in the attackers army<br>Includes Meks and Vehicles</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of Infantry in the attackers army<br>Includes non-Powered, BA, and ProtoMeks</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of Infantry in the attackers army<br>Includes non-Powered, BA, and ProtoMeks</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of movement points, i.e. Walking,<br>that any unit in the attackers army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of jump points<br>that any unit in the attackers army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of jump points<br>that any unit in the attackers army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "Max Tons any unit in the attackers army can have for this op");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV difference between the highest and lowest counted units.<br>If % BV spread is used, this will be an added value to the calculated percent</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min BV difference between the highest and lowest counted units.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>BV Spread will be a % of the army's BV.<br>Float value, so 0.2 = 20%</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest total skill, Gunnery + Piloting, that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest total skill, Gunnery + Piloting, that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest Piloting that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest Piloting that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest Gunnery that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest Gunnery that an<br>attacking Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max Average piloting skills a attacking army can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min Average piloting skills a attacking army can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Minimum percent of an army that may be Clantech</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Maximum percent of an army that may be Clantech</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max Number of Non-Infantry a Defender my use in this op<br>This includes Meks and Vehicles</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of Non-Infantry a defender must use in this op<br>This includes Meks and Vehicles</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max Number of Infantry a Defender my use in this op<br>This includes non-Powered Infantry, BA, and ProtoMeks</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of Infantry a defender must use in this op<br>This includes non-Powered Infantry, BA, and ProtoMeks</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of movement points, i.e. Walking,<br>that any unit in the defenders army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of jump points<br>that any unit in the defenders army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of jump points<br>that any unit in the defenders army can have<br>to participate in this operation</html>");
        ...
        BaseTextField.setToolTipText(
                "Max Tonnage any unit in the defenders army may have for this op");
        ...
        BaseTextField.setToolTipText(
                "Min tonnage any unit in the defeneders army may have for this op");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest total skill, Gunnery + Piloting, that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest total skill, Gunnery + Piloting, that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest Piloting that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest Piloting that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Highest Gunnery that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Lowest Gunnery that a<br>defending Units pilot can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max Average piloting skills a defending army can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min Average piloting skills a defending army can have<br>NOTE: Units will not be checked if they<br>are not counted for the BV Spread</html>");
        ...
        BaseTextField.setToolTipText(
                "What it costs the attacker, in reward points, to preform this op");
        ...
        BaseTextField.setToolTipText(
                "What it costs the defender, in reward points, to preform this op");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV to be presumed for attack/def player when<br>assigning artillery. Ceiling for modifiers.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV to be presumed for defend/def player when<br>assigning artillery. Ceiling for modifiers.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min BV to be presumed for attack/defender player<br>when assigning gun emplacements. Floor for modifiers.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV to be presumed for attack/def player when<br>assigning gun emplacements. Ceiling for modifiers.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min BV to be presumed for defend/defender player<br>when assigning gun emplacements. Floor for modifiers.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max BV to be presumed for defend/def player when<br>assigning gun emplacements. Ceiling for modifiers.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If true, attack players will receive<br>normal gun emplacements. Set false to make the<br>grant lopsided.</html>");
        ...
        BaseCheckBox = new JCheckBox("Turret");
        BaseCheckBox.setToolTipText(
                "<html>If true, defend players will receive<br>normal gun emplacements. Set false to make the<br>grant lopsided.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Set the BV amount for 1 conventional mine i.e set to 100<br>and the total of both armies bv is 10k you get 100 mines</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Set the Ton amount for 1 conventional mine i.e set to 100<br>and the total of both armies ton is 500 you get 5 mines</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If true, attacking players will receive mines.<br>Set false to make the grant lopsided.</html>");
        ...
        BaseCheckBox = new JCheckBox("Mine");
        BaseCheckBox.setToolTipText(
                "<html>If true, defending players will receive mines.<br>Set false to make the grant lopsided.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If true any support units giving to the task"
        ...
        BaseCheckBox.setToolTipText(
                "<html>If set all bots will be added to the same team"
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of MUL armies a Defender can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of MUL armies a Defender can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of MUL Infantry a Defender can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of MUL Infantry a Defender can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of MUL armies a Attacker can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of MUL armies a Attacker can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Min number of MUL Infantry a Attacker can receive</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Max number of MUL Infantry a Attacker can receive</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If true, attacking players will receive Mul Armies.</html>");
        ...
        BaseCheckBox = new JCheckBox("MUL Armies");
        BaseCheckBox.setToolTipText(
                "<html>If true, defending players will receive Mul Armies.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>1 flu added to Base pay for every complete<br>increment. ie - if 2, will add BV/2 flu to pay</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>1 Exp added to Base pay for every complete<br>increment. ie - if 2, will add BV/2 Exp to pay</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>1 RP added to Base pay for every complete<br>increment. ie - if 2, will add BV/2 RP to pay</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Double value. The base amounts + bv adjustments +<br>flat adjustments are modified upward by this percent.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Double value. The base amounts + bv adjustments +<br>flat adjustments are modified downward by this percent.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><b>NOTE:</b>This is a double field. 0.25 = 25%<br>This is the min difference between the starting BV of the losers army<br>and his ending BV. if the difference is less then this<br>the player will not get a full payout</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><b>NOTE:</b>This is an Integer Field. 25 = 25%<br>Chance, out of 100, that a unit that flees the field is scrapped. Default 0.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><b>NOTE:</b>This is an Integer Field. 25 = 25%<br>Chance, out of 100, that a unit that is pushed off the field is scrapped. Default 0.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><b>NOTE:</b>This is an Integer Field. 25 = 25%<br>Chance, out of 100, that an engined unit is utterly<br>destroyed while trying to be salvaged. Default 0</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><html><b>NOTE:</b>This is an Integer Field. 25 = 25%<br>Chance, out of 100, that a legged/gyroed unit is utterly destroyed while trying to be salvaged. Default 0</html>");
        ...
        BaseTextField.setToolTipText(
                "<html><b>NOTE:</b>This is an Integer Field. 25 = 25%<br> Chance, out of 100, that a legged unit is utterly destroyed while trying to be salvaged.  Default 0</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Adjustment after each salvage attempt. IE - if base<br>is 50, and adjust is 20, 2nd attempt will be 30 or 70<br>30 if salvage attempt was successful 70 if not.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>UnitBV/BVToBoost is the starting cost of salvage. If<br>set to 0, salvage will be *FREE*. IMPORTANT!</html>");
        ...
        BaseCheckBox.setToolTipText(
                "if true support units, arty, mul armies, and others go to the salvage pool instead of going away");
        ...
        BaseCheckBox.setToolTipText(
                "move salvage list to the destroyed list, effectively causing all salvage to be destroyed");
        ...
        BaseCheckBox.setToolTipText(
                "set false to forbid non-conquer players from using this attack");
        BaseCheckBox.setName("AllowNonConqToUse");
        newbiePanel1.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Allow Against NonConquer");
        BaseCheckBox.setToolTipText(
                "set false to forbid players from using this attack against a non-conq player");
        ...
        BaseCheckBox.setToolTipText(
                "<html>if enabled, no units will be destroyed and no units will<br>be salvaged (essentially sets up a sim-task).</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If enabled then players in the same faction<br>will be able to attack each other.</html>");
        ...
        BaseTextField = new JTextField(5);
        BaseTextField.setToolTipText(
                "<html>Double. Controls amount of production players generate<br>Set to 0 to disable production. Defaults to 1.0, the<br>same amount that a solitary army would generate.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Base number of units taken by winning attacker<br>from factories on the planet</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Maximum number of units to award to a player<br>instead of the faction</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Maximum BV of single unit to award to a player<br>based on a percentage of the BV of<br>their initial force.<br><br>This stops players from recovering a WarShip<br>with a single ASF.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Maximum total BV of units to award to a player<br>based on a percentage of the BV of<br>their initial force.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from Mek factories</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from Vee factories</html>");
        BaseCheckBox.setName("ForceProduceAndCaptureVees");
        validAttackerFactoryPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Inf Factories");
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from Inf factories</html>");
        BaseCheckBox.setName("ForceProduceAndCaptureInfs");
        validAttackerFactoryPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("BA Factories");
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from BA factories</html>");
        BaseCheckBox.setName("ForceProduceAndCaptureBAs");
        validAttackerFactoryPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Aero Factories");
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from Aero factories</html>");
        BaseCheckBox.setName("ForceProduceAndCaptureAeros");
        validAttackerFactoryPanel.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Proto Factories");
        BaseCheckBox.setToolTipText(
                "<html>Only capture components and force produce units from Proto factories</html>");
        ...
        BaseTextField.setToolTipText(
                "Max amount of delay to apply, regardless of BV/units involved.");
        ...
        BaseTextField.setToolTipText(
                "Number of components to destroy based on units used in the op");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If enabled then the attacker will start the game with<br>the stolen units and must get them off the battle field.</html>");
        BaseCheckBox.setName("AttackerUnitsTakenBeforeFightStarts");
        attackerBox.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Unclaimed Land");
        BaseCheckBox.setToolTipText(
                "<html>If enabled then the attacker can target a planet without claimed land and will automatically capture CP.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>bonus XP given to all surviving units, based on the starting size of the game<br>if there are 10 units in game, and Adjust is set to 10, all units will get +1<br>XP. if there are 10 in game and Adjust is 5, all units will get +2 XP, etc.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>bonus XP given to all surviving units, based on the starting size of the game. if<br>total BV in game is 30,000 and Adjust is 10,000, all units will get +3 XP.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>bonux XP given to all surviving units owned by a winning player</html>");
        ...
        BaseTextField.setToolTipText(
                "bonus XP given to all surviving units owned by a defending player");
        ...
        BaseTextField.setToolTipText(
                "<html>flat amount of XP given to a unit for each kill it earned. this is granted only<br>to the killing unit, and only if it survives or is salvaged by original owner<br>with original pilot.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>KilledUnitsBV/KillBonusXPforBV. bonus XP based on the BV of units killed. added<br>only to the killing unit, and only if the unit survives or is salvaged by its<br>original owner with original pilot.</html>");
        ...
        BaseTextField.setToolTipText(
                "Maximum Construction Factor each building can have (How many points of damage it'll take)");
        ...
        BaseCheckBox.setToolTipText(
                "<html>defaults to true.<br>If selected a random edge is selected<br>and the defender is set to that<br>and the attacker to the opposite edge.<br>If not selected the buildings<br>will be placed randomly around the map.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Number of Delay ticks set to the planet factories for each building destroyed,<br>if they meet the min amount of buildings destroyed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Amount of Money the attacker gets for each building destroyed,<br>if they meet the min amount of buildings destroyed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Amount of Exp the attacker gets for each building destroyed,<br>if they meet the min amount of buildings destroyed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Amount of Flu the attacker gets for each building destroyed,<br>if they meet the min amount of buildings destroyed.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Amount of RP the attacker gets for each building destroyed,<br>if they meet the min amount of buildings destroyed.</html>");
        ...
        BaseTextField.setToolTipText(
                "Amount of Money the defender gets for each building left standing.");
        ...
        BaseTextField.setToolTipText(
                "Amount of Exp the defender gets for each building left standing.");
        ...
        BaseTextField.setToolTipText(
                "Amount of Flu the defender gets for each building left standing.");
        ...
        BaseTextField.setToolTipText(
                "Amount of RP the defender gets for each building left standing.");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Check if you want MM to generate a city for this op<br>Using the settings below</html>");
        ...
        BaseTextField.setToolTipText(
                "Number of city blocks for this city. This goes west to east and north to south");
        ...
        BaseTextField.setToolTipText(
                "<html>1-100 This is the % chance that a hex will contain a building the higher the number<br>the more buildings will be generated.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If this is turned on DestroyEnemyBV field well be sent to MM</html>");
        BaseCheckBox.setName("UseDestroyEnemyBV");
        checkBoxBox.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Use BV Ratio Percent?");
        BaseCheckBox.setToolTipText(
                "<html>If this is turned on UseBVRatioPercent field will be sent to MM.</html>");
        BaseCheckBox.setName("UseBVRatioPercent");
        checkBoxBox.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Use Game Turn Limit?");
        BaseCheckBox.setToolTipText(
                "<html>If this is turned on UseGameTurnLimit field will be sent to MM.</html>");
        BaseCheckBox.setName("UseGameTurnLimit");
        checkBoxBox.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Use Kill Count?");
        BaseCheckBox.setToolTipText(
                "<html>If this is turned on UseKillCount field will be sent to MM.</html>");
        BaseCheckBox.setName("UseKillCount");
        checkBoxBox.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Use Unit Commanders?");
        BaseCheckBox.setToolTipText(
                "<html>If this is turned on UseUnitCommanders field will be sent to MM.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>The number of victory conditions that must<br>be achieved by the winning team.<br>Default 0 (off)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Destroy/damage a certain percentage<br>of the enemy force to win,<br>measured by current BV / original BV</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Friendly forces outnumber enemy forces by a percentage ratio.<br>Measured by current BV.<br>E.G. 300 means you have 3x the surviving BV of the enemy.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Minimum number of unit commanders this op needs for players to launch/defend it.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Maximum number of unit commanders this op needs for players to launch/defend it.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If checked players are divided up based on factions</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Minimum number of players needed for<br>the Free For All to launch.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If checked the operation picks what sides<br>the attacker and defender start on.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy Northwest (Deep)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy North (Deep)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy Northeast (Deep)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy Southeast (Deep)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy South (Deep)</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Chances for the attacker to deploy Southwest (Deep)</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If checked use the Operation map instead of the terrain on the planet.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Name of the map to use or surprise/generated if using sizes</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>X Size of the map<br>Also can be used to set the base X size of a generated map.</html>");
        ...
        BaseTextField.setToolTipText(
                "<html>Y Size of the map<br>Also can be used to set the base Y size of a generated map.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If checked, support Aero will count as normal aero for purposes of the ratio<br>If unchecked, support aero will not count toward the ratio</html>");
        supportRatioPanel.add(BaseCheckBox);

        attackerRatioPanel.setLayout(new VerticalLayout());
        attackerRatioPanel.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Attacker"));
        ...
        defenderRatioPanel.setBorder(
                BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Defender"));
        ...
        aeroRatioPanel.setBorder(
                BorderFactory.createTitledBorder(
                        BorderFactory.createEtchedBorder(), "Aero Ratios"));
        ...
        ConfigPane.addTab(
                ...
                null,
                factionPanel,
                "Exlude factions from using or defending the op.");
        ConfigPane.addTab(
                "Meta Awards",
                null,
                metaSetupPanel,
        ...
        ConfigPane.addTab(
                "Newbie Ops", null, newbieOpsPanel, "how to treat the new player in your life");
        ConfigPane.addTab("Operation Costs", null, costsPanel, "Cost to attack or defend an op");
        ConfigPane.addTab(
                "Operation Results", null, opresultsPanel, "who gets payed what and how much");
        ConfigPane.addTab(
                "Player Properties",
                null,
                playerPropertiesPanel,
                "<html>mins/maxes for players if<br>they can attack/defend an op</html>");
        ConfigPane.addTab(
                "Pilot Exp",
                null,
                pilotExpPanel,
                "Set up how unit pilots will be reward for surviving.");
        ConfigPane.addTab(
                "Ranges & Misc",
                null,
                rangePanel,
        ...
        ConfigPane.addTab(
                ...
                null,
                scenarioPanel,
                "<html>Arty/mines anything given to an attacker/<br>defender besides their own units</HTML>");
        ...
        ConfigPane.addTab(
                "Victory Conditions", null, victoryPanel, "Victory Conditions For MegaMek");
        ConfigPane.addTab("Player Flags", null, flagsPanel, "Player Flag settings");
        ConfigPane.addTab(
                "Unit Ratios", null, unitRatiosPanel, "Limit access to op by unit ratios");
        ...
        for (int fieldPos = panel.getComponentCount() - 1; fieldPos >= 0; fieldPos--) {
            ...
            if (field instanceof JPanel) {
                ...
                if (Boolean.parseBoolean(value)
                        != Boolean.parseBoolean(defaultOperationInfo.getDefault(key))) {
                    p.println(key + "=" + value);
                }
            } else if (field instanceof JComboBox) {
                JComboBox<String> combo = (JComboBox) field;
                ...
                if (Integer.parseInt(value)
                        != Integer.parseInt(defaultOperationInfo.getDefault(key))) {
                    p.println(key + "=" + value);
                }
            } else if (field instanceof FlagTable) {
                FlagTable table = (FlagTable) field;
    ...
    private JMenu createEditMenu() {
        ...
        jMenuSendCurrentOperationFile.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
        ...
        jMenuRetrieveOperationFile.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ((MWClient) mwclient)
                                .getMainFrame()
        ...
        jMenuSetOperationFile.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ((MWClient) mwclient)
                                .getMainFrame()
        ...
        jMenuSetNewOperationFile.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ((MWClient) mwclient)
                                .getMainFrame()
        ...
        jMenuSendAllOperationFiles.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ((MWClient) mwclient)
                                .getMainFrame()
        ...
        jMenuUpdateOperations.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ((MWClient) mwclient)
                                .getMainFrame()
        ...
        int userLevel =
                ((MWClient) mwclient).getUser(((MWClient) mwclient).getUsername()).getUserlevel();
        if (userLevel >= ((MWClient) mwclient).getData().getAccessLevel("RetrieveOperation")) {
            jMenuOperations.add(jMenuRetrieveOperationFile);
        }
        if (userLevel >= ((MWClient) mwclient).getData().getAccessLevel("SetOperation")) {
        ...
        if (userLevel >= ((MWClient) mwclient).getData().getAccessLevel("UpdateOperations")) {
    ...
    private void jMenuSendCurrentFile_actionPerformed(ActionEvent e) {
        ...
        ((MWClient) mwclient)
                .sendChat(GameHost.CAMPAIGN_PREFIX + "c setoperation#short#" + opData.toString());
    }
