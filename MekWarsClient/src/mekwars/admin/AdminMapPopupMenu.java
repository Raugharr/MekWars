        ...
        item.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent ex) {
                        ...
                        PlanetNameDialog pnd =
                                new PlanetNameDialog(mwclient, "Select a Planet", null);
        ...
        item.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ex) {
                        String planetName =
                                JOptionPane.showInputDialog(
                                        mwclient.getMainFrame(), "Planet Name?");
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent ex) {
                        ...
                        if (result == JOptionPane.YES_OPTION) {
                            mwclient.sendChat(
                                    GameHost.CAMPAIGN_PREFIX + "c admindestroyplanet#" + pname);
                            mwclient.refreshData();
                            mp.repaint();
                        }
                    }
        ...
        item.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent ex) {
                        ...
                        OpFlagSelectionDialog OFSD =
                                new OpFlagSelectionDialog(mwclient, "Select Flags(s)!");
