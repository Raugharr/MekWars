...
public final class SubFactionConfigurationDialog implements ActionListener {
     ...
     * @param client
     */
    public SubFactionConfigurationDialog(
            MWClient mwclient, String houseName, String subFactionName) {
        ...
        for (int type = 0; type < CUnit.MAXBUILD; type++) {
            for (int weight = 0; weight <= CUnit.ASSAULT; weight++) {
                ...
                BaseCheckBox.setToolTipText(
                        "<html>Check to allow subfaction memebers to buy new<br>"
                                + CUnit.getWeightClassDesc(weight)
                                + " "
                                + CUnit.getTypeClassDesc(type)
                                + "</html>");
                BaseCheckBox.setName(
                        "CanBuyNew"
                                + CUnit.getWeightClassDesc(weight)
                                + CUnit.getTypeClassDesc(type));
                ...
                BaseCheckBox =
                        new JCheckBox(
                                "Can buy used "
                                        ...
                                        + CUnit.getTypeClassDesc(type));
                BaseCheckBox.setToolTipText(
                        "<html>Check to allow subfaction memebers to buy used<br>"
                                + CUnit.getWeightClassDesc(weight)
                                + " "
                                + CUnit.getTypeClassDesc(type)
                                + "</html>");
