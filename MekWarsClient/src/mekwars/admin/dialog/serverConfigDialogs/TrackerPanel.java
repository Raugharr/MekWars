...
/**
 * @author Spork
 *     <p>A JPanel where we configure everything having to do with the tracker. Currently only
 *     recreating the old tracker information. Next step is to add HPGNet capabilities
 */
public class TrackerPanel extends JPanel {
    ...
    private void init(String uuid) {
        ...
        String description =
                "<HTML>The tracker information has been moved out of serverdata.txt and into<br />"
        ...
        baseTextField.setToolTipText(
                "The tracker's IP address or host name.  The official one is at tracker.mekwars.org");
