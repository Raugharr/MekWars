...
public class PilotsPanel extends JPanel {
    ...
    public PilotsPanel(MWClient mwclient) {
        ...
        baseTextField.setToolTipText(
                "<html>% chance for a pilot to lose<br>accumulated XP in the Queue</html>");
        ...
        baseTextField = new JTextField(5);
        pilotOptionsSpring2.add(
                new JLabel("Retired Pilot Takes Mech Chance:", SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "<html> Chance a retiring pilot takes his unit with him.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>If Checked Crews stay with thier units after being donated.</html>");
        BaseCheckBox.setName("CrewsStayWithUnits");
        pilotCBoxGrid.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("All Pilots Level");
        BaseCheckBox.setToolTipText(
                "<html>If Checked Then even losing pilots will have a chance to level.</html>");
