...
public class CombatPanel extends JPanel {
    ...
    public CombatPanel() {
        ...
        BaseCheckBox.setToolTipText(
                "If set to true then players can recoup repair costs by scrapping salvaged units");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Allow units in an army<br>to go active if they are damaged.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Checking this will always use a base 4/5 pilot for BV calcs</html>");
        combatMMOptionsSpring.add(BaseCheckBox);
