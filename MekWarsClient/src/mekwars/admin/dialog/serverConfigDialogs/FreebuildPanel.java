...
public class FreebuildPanel extends JPanel {
    ...
    public FreebuildPanel(MWClient mwclient) {
        ...
        baseCheckBox.setToolTipText(
                "<HTML>Lets Sol players build from all build tables instead of defining a table.</HTML>");
        ...
        baseCheckBox.setToolTipText(
                "<HTML>Set this if you want players to be able to build free units after defection. Uses house table.</HTML>");
        baseCheckBox.setName("FreeBuild_PostDefection");
        panel2.add(baseCheckBox);

        baseCheckBox = new JCheckBox("Limit Post Defection Only");
        baseCheckBox.setToolTipText(
                "<HTML>Set this if you want SOL free build to work without limits, and only limit free build after defection</HTML>");
