...
/**
 * A JPanel implementation detailing the Christmas Units handed out by the server for Christmas
 * Season.
 *
 * @author Spork
 * @version 2016.10.26
...
public class ChristmasUnitPanel extends JPanel {
    ...
    public ChristmasUnitPanel() {
        ...
        button.setToolTipText(
                "<html>One of each unit on the Christmas list "
        ...
        button.setToolTipText(
                "<html>X of each unit on the Christmas list "
                        + "will be given the first time a player logs on "
                        + "after the start of the Christmas season.</html>");
        ...
        button.setToolTipText(
                "<html>X units will be selected randomly from the "
