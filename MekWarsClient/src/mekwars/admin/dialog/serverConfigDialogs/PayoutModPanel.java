...
public class PayoutModPanel extends JPanel {
    ...
    private JPanel setUpPanel(JPanel panel, int type) {
        ...
        baseCheckBox.setToolTipText(
                "<html>If checked, " + ttText + " payout will be modified based on ELO</html>");
        ...
        baseCheckBox.setToolTipText(
                "<html>If checked, apply modified payout to higher-ranked player.<br>Otherwise, he'll get unmodified payout</html>");
        panel.add(baseCheckBox);

        baseCheckBox = new JCheckBox("For Lower Player");
        baseCheckBox.setName("ModifyOpPayoutByELO_" + typeName + "_Lower");
        baseCheckBox.setToolTipText(
                "<html>If checked, apply modified payout to lower-ranked player.<br>Otherwise, he'll get unmodified payout</html>");
        panel.add(baseCheckBox);

        baseTextField = new JTextField(5);
        baseTextField.setName("ModifyOpPayoutByELO_" + typeName + "_MinELO");
        baseTextField.setToolTipText(
                "<html>If a player's ELO is below this, payout will be calculated using this value</html>");
        ...
        baseTextField.setToolTipText(
                "<html>If a player's ELO is above this, payout will be calculated using this value</html>");
        panel.add(new JLabel("Max ELO:"));
        panel.add(baseTextField);

        panel.setBorder(
                BorderFactory.createTitledBorder(
                        BorderFactory.createRaisedBevelBorder(), typeName));
    ...
    public PayoutModPanel() {
        ...
        upperPanel.setBorder(
                BorderFactory.createTitledBorder(
                        BorderFactory.createRaisedBevelBorder(), "Options"));
        ...
        baseCheckBox.setToolTipText(
                "<html>If checked, payout will be changed based on ELO of players involved.");
        ...
        baseTextField.setToolTipText(
                "<html><p>Not really a multiplier, but a power.  The ELO ratio (loser / winner) will be raised to this power to determine change of actual payout.</p><p>Please refer to documentation for a more complete discussion of this mechanic.</p></html>");
        ...
        upperPanel.setPreferredSize(
                new Dimension(
                        Math.max(
                                upperPanel.getPreferredSize().width,
                                fluPanel.getPreferredSize().width),
                        upperPanel.getPreferredSize().height));

        // Exp Mod panel
        JPanel expModPanel = new JPanel();
        expModPanel.setBorder(
                BorderFactory.createTitledBorder(
                        BorderFactory.createRaisedBevelBorder(), "Experience Mod"));
        baseCheckBox = new JCheckBox("Experience Affects Land Exchange");
        baseCheckBox.setName("ModifyLandExchangeByExp");
        baseCheckBox.setToolTipText(
                "<html>If checked, land exchange will be reduced until players meet an experience threshold<br />Formula used is:<br /><p align='center'><b>Math.min(1, ( (<i>base</i> + exp) / <i>maximum</i> ))</b></p></html>");
