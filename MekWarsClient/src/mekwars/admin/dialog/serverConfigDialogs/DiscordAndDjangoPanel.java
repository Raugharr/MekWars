...
public class DiscordAndDjangoPanel extends JPanel {
    ...
    private void init() {
        ...
        String desc =
                "<HTML>Discord comes with functionality allowing for creation of webhooks and bots. This section<br>"
        ...
        String desc2 =
                "<HTML>!NOTE: Django battle board also requires Enable Player Data Capture (JSON) to be <br>"
        ...
        baseCheckBox.setToolTipText(
                "Enable rankings and game output to be sent to a Discord channel");
        ...
        baseTextField.setToolTipText(
                "Address for the webhook to which game results and such should be sent.");
        ...
        baseCheckBox.setToolTipText(
                "<HTML>This allows the saving of player data to a JSON file for the discord bot to read from</HTML>");
        baseCheckBox.setName("Enable_BotPlayerInfo");
        panel2a.add(baseCheckBox);

        baseCheckBox = new JCheckBox("Enable Bot Chat Capture (TXT)");
        baseCheckBox.setToolTipText(
                "<HTML>Logs all chat to a file which the discord bot can read from</HTML>");
        ...
        baseTextField.setToolTipText(
                "<HTML>Location of file to use with bot, the code 'should' generate this file if it does not exit </HTML>");
        ...
        baseCheckBox.setToolTipText(
                "<HTML>Saves battles to json for django battle board at data/django/battles/ </HTML>");
