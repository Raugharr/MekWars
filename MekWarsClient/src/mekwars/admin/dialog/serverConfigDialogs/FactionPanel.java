...
public class FactionPanel extends JPanel {
    ...
    public FactionPanel(MWClient mwclient) {
        ...
        factionSpring1.add(
                new JLabel(
                        "Starting " + mwclient.moneyOrFluMessage(true, true, -1) + ":",
        ...
        factionSpring1.add(
                new JLabel(
                        "Starting " + mwclient.getServerConfigs("RPShortName") + ":",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "Number of "
        ...
        factionSpring1.add(
                new JLabel(
                        "Starting " + mwclient.getServerConfigs("FluShortName") + ":",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "Number of "
        ...
        baseTextField.setToolTipText(
                "<html>Integer Field, Access Level given to a player when they are promoted to the faction leadership<br>NOTE: if their access level is already higher then this it will not be changed.</html>");
        ...
        baseCheckBox.setToolTipText(
                "<html>If checked, player names will replace faction names in<br>news feed description of games.</html>");
        baseCheckBox.setName("ShowCompleteGameInfoInNews");
        factionCBoxSpring.add(baseCheckBox);

        baseCheckBox = new JCheckBox("Allow Planets in MOTD");
        baseCheckBox.setToolTipText(
                "If checked, players can use the new <planet> tags in their MOTD");
        ...
        // SubFaction Options
        JPanel subFactionMain =
                new JPanel(new VerticalLayout(5, VerticalLayout.CENTER, VerticalLayout.TOP));
        ...
        baseCheckBox.setToolTipText(
                "<html>If checked, House Leaders will not be notified <br>when a player no longer qualifies for a subfaction.</html>");
        baseCheckBox.setName("disableDemotionNotification");
        subFactionSpring.add(baseCheckBox);

        baseCheckBox = new JCheckBox("Allow Subfaction Self Promotion");
        baseCheckBox.setToolTipText(
                "If checked, a user will be allowed to self promote into a subfaction, can be used once.");
        ...
        baseCheckBox.setToolTipText(
                "Disables the normal methods of player subfaction demotion. Likely used with disable premotion to lock player into subfaction.");
        baseCheckBox.setName("Disable_Demote_Subfaction");
        subFactionSpring.add(baseCheckBox);

        baseCheckBox = new JCheckBox("Enforce Subfaction Factory Access");
        baseCheckBox.setToolTipText(
                "If checked, subfaction level MUST be equal to factory level to use it");
