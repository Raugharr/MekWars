...
public class UnitResearchPanel extends JPanel {
    ...
    public UnitResearchPanel(MWClient mwclient) {
        ...
        mainResearchPanel.add(
                new JLabel(
                        "Base Research " + mwclient.moneyOrFluMessage(true, false, -1, false) + ":",
        ...
        mainResearchPanel.add(
                new JLabel(
                        "Tech Level " + mwclient.moneyOrFluMessage(true, false, -1, false) + ":",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "<HTML>"
                        + mwclient.moneyOrFluMessage(true, false, -1, false)
        ...
        mainResearchPanel.add(
                new JLabel(
                        "Tech Level " + mwclient.moneyOrFluMessage(false, false, -1, false) + ":",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "<HTML>"
                        + mwclient.moneyOrFluMessage(true, false, -1, false)
        ...
        baseTextField.setToolTipText(
                "<HTML>Max number of shares per unit a faction can research.</html>");
