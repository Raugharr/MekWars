...
public class LinksPanel extends JPanel {
    ...
    private void init() {
        ...
        String description =
                "<HTML>Enabling the Link Area will allow the SO to create up to 3 quick link buttons<br>"
        ...
        baseCheckBox.setToolTipText(
                "<HTML>Must be enabled if you wish to use this feature.</HTML>");
        ...
        panel2.setBorder(
                BorderFactory.createTitledBorder(
                        "Icon Location and File Names (Size 30x30 or less)"));
        ...
        baseTextField = new JTextField(30);
        baseTextField.setToolTipText(
                "<HTML>Needs to be a basic HTML. Linking to remote host may slow client load time </HTML>");
