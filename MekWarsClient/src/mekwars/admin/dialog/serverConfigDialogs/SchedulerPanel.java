...
/**
 * A JPanel for scheduled tasks. In this panel, admins can set the frequency with which tasks will
 * execute.
 *
 * @author Spork
 * @version 2016.10.06
...
public class SchedulerPanel extends JPanel {
    ...
    public SchedulerPanel() {
        ...
        tf.setToolTipText(
                "How often (in seconds) an active player will generate componentss for his faction");
