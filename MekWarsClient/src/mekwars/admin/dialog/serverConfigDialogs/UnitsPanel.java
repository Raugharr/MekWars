...
public class UnitsPanel extends JPanel {
    ...
    private void init() {
        ...
        String quirksToolTip =
                "<html> Allows mekwars to 'see' quirks, also checks to make sure that the quirk file in use<br>"
        ...
        for (int unitType = Unit.MEK; unitType <= Unit.AERO; unitType++) {
            for (int unitWeight = Unit.LIGHT; unitWeight <= Unit.ASSAULT; unitWeight++) {
                ...
                if (unitType == Unit.MEK) {
                    ...
                    baseName =
                            Unit.getWeightClassDesc(unitWeight) + Unit.getTypeClassDesc(unitType);
                }

                costGrid.add(
                        new JLabel(
                                Unit.getWeightClassDesc(unitWeight)
                                        + " "
        ...
        baseCheckBox.setToolTipText(
                "<html>Check to use MM calculated costs for each unit.<br>The calculated cost will be used or the unit set price which ever is higher<br>Requires a reboot of the server.</html>");
        ...
        commandersPanel.setPreferredSize(
                new Dimension(
                        unitUsePanel.getPreferredSize().width,
                        commandersPanel.getPreferredSize().height));
        miscCheckBoxPanel.setPreferredSize(
                new Dimension(
                        unitUsePanel.getPreferredSize().width,
                        miscCheckBoxPanel.getPreferredSize().height));
        weightPanel.setPreferredSize(
                new Dimension(
                        unitUsePanel.getPreferredSize().width,
                        weightPanel.getPreferredSize().height));
        typesPanel.setPreferredSize(
                new Dimension(
                        unitUsePanel.getPreferredSize().width,
                        typesPanel.getPreferredSize().height));
        miscPanel.setPreferredSize(
                new Dimension(
                        unitUsePanel.getPreferredSize().width,
                        miscPanel.getPreferredSize().height));
        ...
        rightPanel.setPreferredSize(
                new Dimension(
                        rightPanel.getPreferredSize().width, leftPanel.getPreferredSize().height));
        add(leftPanel);
        add(rightPanel);
    }
