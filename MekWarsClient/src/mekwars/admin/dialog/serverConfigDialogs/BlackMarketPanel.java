...
public class BlackMarketPanel extends JPanel {
    ...
    public BlackMarketPanel(MWClient mwclient) {
        ...
        bmTextSpring.add(
                new JLabel(
                        "BM Bid " + mwclient.moneyOrFluMessage(false, true, -1) + " Cost:",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                mwclient.moneyOrFluMessage(false, false, -1) + " charge for bidding on the BM.");
        ...
        bmTextSpring.add(
                new JLabel(
                        "BM Sale " + mwclient.moneyOrFluMessage(false, true, -1) + " Cost:",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "Base "
        ...
        bmTextSpring.add(
                new JLabel(
                        "BM Size " + mwclient.moneyOrFluMessage(false, true, -1) + " Cost:",
                        SwingConstants.TRAILING));
        baseTextField.setToolTipText(
                "[SizeCost] * [Unit Weightclass] added to "
                        + mwclient.moneyOrFluMessage(false, true, -1)
                        + " cost of a BM sale.");
        ...
        BaseCheckBox.setToolTipText(
                "Use the parts blackmarket this coencides with using parts to repair");
        ...
        BaseCheckBox.setToolTipText(
                "If checked IS Player are allowed to buy clan tech on the BM and visa versa.");
        ...
        baseRadioButton.setToolTipText(
                "<html>Vickrey auction is a modified highest sealed bid auction. Winner<br>"
        ...
        baseRadioButton.setToolTipText(
                "<html>Winner is simply the highest offering person who can<br>"
