...
public class MiscOptionsPanel extends JPanel {
    ...
    public MiscOptionsPanel() {
        ...
        baseTextField.setToolTipText(
                "Year of Campaign.  This will modify the TechLevel ratings in MM");
        ...
        baseTextField.setToolTipText(
                "Minimum BV for an army to be counted during ticks and slices");
        ...
        baseTextField.setToolTipText(
                "Maximum BV for an army to be counted during ticks and slices");
        ...
        baseTextField.setToolTipText(
                "Amount of time (in seconds) a player must remain active before returning to reserve");
        ...
        baseTextField.setToolTipText(
                "<HTML>MM version clients should have in order to host (and play)<br>This is Set by the server from the MM file in the server folder<br>Set to -1 to disable</html>");
        ...
        baseTextField.setToolTipText(
                "<html>short name you want displayed for your servers money<br>i.e. CB for CBills</html>");
        ...
        baseTextField.setToolTipText(
                "<html>short name you want displayed for your servers influence<br>i.e. flu for influence</html>");
        ...
        baseTextField.setToolTipText(
                "<html>short name you want displayed for your server's RP</html>");
        ...
        baseTextField.setToolTipText(
                "<html>Max amount of time before an Idle playere is kicked<br>Set to 0 to turn off this option</html>");
        ...
        baseTextField.setToolTipText(
                "Minimum Merc contract duration. NOTE: Unit, PP, and Land are divided by 10.");
        ...
        baseTextField.setToolTipText(
                "Name of training faction. Changing from SOL isn't recommended.");
        ...
        baseTextField.setToolTipText(
                "<html>Number of hours between each backup.<br>The backup will run and create zip files for planets.dat<br>houses.dat and all of the playerfiles<br>The zip files will be stored in ./campaign/backup</html>");
        ...
        baseTextField.setToolTipText(
                "<html>Number of days a player is inactive before they get purged.</html>");
        ...
        BaseCheckBox.setToolTipText(
                "If checked, all players are shown as active in the player list.");
        ...
        BaseCheckBox.setToolTipText(
                "<html>Show the complete capacity description for units in the overlay popup</html>");
        BaseCheckBox.setName("UseFullCapacityDescription");
        miscCBoxSpring.add(BaseCheckBox);

        BaseCheckBox = new JCheckBox("Show full capacity in detail display");
        BaseCheckBox.setToolTipText(
                "<html>Show the complete capacity description for units when viewing</html>");
