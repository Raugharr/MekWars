...
public class ArtilleryPanel extends JPanel {
    ...
    public ArtilleryPanel() {
        ...
        BaseCheckBox.setToolTipText(
                "If checked, server tries to assign assault pieces before light");
        ...
        baseTextField.setToolTipText(
                "Filename of the units to load as assault artillery seperated by $");
        ...
        baseTextField.setToolTipText(
                "Filename of the units to load as heavy artillery seperated by $");
        ...
        baseTextField.setToolTipText(
                "Filename of the units to load as medium artillery seperated by $");
        ...
        baseTextField.setToolTipText(
                "Filename of the units to load as light artillery seperated by $");
        ...
        baseTextField.setToolTipText(
                "BV removed from task total (all players) when assault is assigned");
        ...
        baseTextField.setToolTipText(
                "BV removed from task total (all players) when heavy is assigned");
        ...
        baseTextField.setToolTipText(
                "BV removed from task total (all players) when medium is assigned");
        ...
        baseTextField.setToolTipText(
                "BV removed from task total (all players) when light is assigned");
        ...
        baseTextField.setToolTipText(
                "Distance, in mapsheets, that Arty is deployed from a players home edge");
        ...
        baseTextField.setToolTipText(
                "Filename of the units to load as assault Guns seperated by $");
