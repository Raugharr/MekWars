 ...
 * @version 2016.10.06
 */
public class DefaultCampaignOptions {
    private static final Logger LOGGER = LogManager.getLogger(DefaultCampaignOptions.class);
    ...
    protected void createDefaults() {
        ...
        defaults.setProperty("Christmas_StartDate", "2026-12-01");
        defaults.setProperty("Christmas_EndDate", "2027-01-01");
