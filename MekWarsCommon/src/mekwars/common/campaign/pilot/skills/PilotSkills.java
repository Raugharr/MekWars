...
public class PilotSkills {
    ...
    @OneToMany private List<PilotSkill> skills = new ArrayList<>();
    ...
    public List<PilotSkill> getPilotSkills() {
        return skills;
    }
    ...
    public String getDescription() {
        ...
        while (i.hasNext()) {
            ...
            if (skill.getLevel() > 1) result += " " + skill.getLevel();
            if (i.hasNext()) {
                result += ", ";
            }
        }
