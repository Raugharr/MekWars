...
/**
 * NOTE: This is a unofficial rule. Pilot gets a -1 to-hit bonus on all missile weapons (LRM, SRM,
 * MRM, RL and ATM). @@author Torren (Jason Tighe)
 */
public class GunneryMissileSkill extends PilotSkill {
    ...
    public int getBVMod(Entity unit, Pilot p) {
        if (CampaignData.cd
                .getCampaignOptions()
                .getBooleanConfig("USEFLATGUNNERYMISSILEMODIFIER")) {
    ...
    public int getBVModFlat(Entity unit) {
        int numberOfGuns = 0;
        int gunneryMissileBVBaseMod =
                CampaignData.cd.getCampaignOptions().getIntegerConfig("GunneryMissileBaseBVMod");
