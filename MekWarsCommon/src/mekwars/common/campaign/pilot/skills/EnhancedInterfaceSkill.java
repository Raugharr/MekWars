 ...
 */
public class EnhancedInterfaceSkill extends PilotSkill {
    ...
    public EnhancedInterfaceSkill(int id) {
        ...
        setDescription(
                "Neural interface to the clan enhanced imaging system -1 To PSR +2 when targeting"
                    + " with TC instead of +3 Can Target without TC at +6 Reduces all forest and"
                    + " Smoke mods to 1 Pilot receives 1 point of damage every time Units IS is"
                    + " hit, If you fail a roll of 7+ BA's recieve 1 extra point of damage every"
                    + " time they are hit.");
    }
