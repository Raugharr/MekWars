...
/**
 * NOTE: This is a unofficial rule. A pilot with this skill receives only 1 pilot hit from
 * ammunition explosions. @@author Torren (Jason Tighe)
 */
public class IronManSkill extends PilotSkill {
    public IronManSkill(int id) {
        super(id, "Iron Man", "IM");
        setDescription(
                "NOTE: This is a unofficial rule. A pilot with this skill receives only 1 pilot hit"
                        + " from ammunition explosions.");
    }
    ...
    public int getBVMod(Entity unit, Pilot pilot) {
        int IronManBVBaseMod =
                CampaignData.cd.getCampaignOptions().getIntegerConfig("IronManBaseBVMod");
        ...
        // CASE (mek gets gutted anyways). PainResistance and IM do not stack so this costs 0 if the
        // pilot also has PR
        boolean b = false;
