...
// /**
//  * Base class for all skill implementations. Overide this if you want to create a cool new skill.
//  * You may want to use SLevelPilotSkill if you want a skill with different Levels.
//  *
//  * <p>Also note, that the skill should not hold any internal state depending on any parameter passed
//  * to any function to it, since the instance created only once and then shared among all pilots.
//  *
...
//         House house = CampaignData.cd.getHouse(p.getCurrentFaction());

//         if (house != null) {
//             return house.getIntegerConfig(getBVModConfig());
//         }
//         return CampaignMain.cm.getIntegerConfig(getBVModConfig());
//     }

//     public abstract int getSkillId();
//     public abstract String getBVModConfig();
// }
