...
public class SerializeEntity {
    public static String serializeEntity(
            Entity e, boolean fullStatus, boolean forceDevastate, boolean useRepairs) {
        ...
        if (fullStatus) {
            if (!(e instanceof MechWarrior) && !(e instanceof EjectedCrew)) {
                ...
                if (forceDevastate) result.append(IEntityRemovalConditions.REMOVE_DEVASTATED + "*");
                else result.append(e.getRemovalCondition() + "*");

                if (e instanceof BipedMech) result.append(Unit.MEK + "*");
                else if (e instanceof QuadMech) result.append(Unit.QUAD + "*");
                else if (e instanceof Tank) result.append(Unit.VEHICLE + "*");
                else if (e instanceof Protomech) result.append(Unit.PROTOMEK + "*");
                else if (e instanceof BattleArmor) result.append(Unit.BATTLEARMOR + "*");
                else if (e instanceof Aero) result.append(Unit.AERO + "*");
                else result.append(Unit.INFANTRY + "*");
            ...
            if (e instanceof Mech) {
                ...
                result.append(
                        e.getBadCriticals(CriticalSlot.TYPE_SYSTEM, Mech.SYSTEM_GYRO, Mech.LOC_CT)
                                + "*");
