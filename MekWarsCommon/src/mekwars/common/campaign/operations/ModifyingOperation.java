...
public class ModifyingOperation {
    ...
    /**
     * ModifyingOperation CONSTRUCTOR. Takes a name (same as used to assemble filenames for param
     * loading) and a set of param values.
     *
     * <p>ModifyingOperations are constructed in OperationLoader.java
     */
    ...
    // METHODS
    /**
     * Method which attempts to look up the value of a given Paramater in an ModOperation's local
     * Tree. If the value is unavailable, a null is returned.
     */
