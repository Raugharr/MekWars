...
public class Operation implements MWXmlSerializable {
    ...
    /**
     * Operation CONSTRUCTOR. Takes a name (used to assemble filenames for param loading) and a set
     * of default vals.
     *
     * <p>Operations are constructed in OperationLoader.java
     */
    ...
    /**
     * Method which attempts to look up the value of a given Paramater in an Operation's local Tree.
     * If the value is unavailable, for any reason (typo, intentionally unset), a default value is
    ...
    /**
     * Method which adds a mod op to this operation's tree of valid mods. Set from
     * OperationManager @ load time, drawn from modops' target params.
     *
     * <p>Toggle mods indicator to show that this op does have potential mods to check for @ startup
