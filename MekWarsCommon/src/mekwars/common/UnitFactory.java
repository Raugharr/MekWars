...
public class UnitFactory implements Serializable {
    ...
    /**
     * Type = 0 means can produce everything Least significant bit = Mek Next Bit = Vehicle Next Bit
     * = Infantry
     */
    private int type;
    ...
    /**
     * @author jtighe
     *     <p>This will allow admins to lock this factory
     */
    ...
    public void setType(int type) {
        ...
        if (type < BUILDALL || type > BUILDAERO) this.type = BUILDMEK;
        else this.type = type;
    }
    ...
    public void binOut(BinWriter out) {
        ...
        out.println(accessLevel, "factoryaccess");
    ...
    public void binIn(BinReader in) throws IOException {
        ...
        accessLevel = in.readInt("factoryaccess");
    ...
    public String getStatus() {
        ...
        if (getTicksUntilRefresh() == 0) result += "Factory is ready to produce a unit.<br>";
        else
            result +=
                    "Factory will be ready to produce a unit in "
    ...
    */
    public int getWeightClass() {
        if (getSize().equalsIgnoreCase("Light")) return Unit.LIGHT;
        else if (getSize().equalsIgnoreCase("Medium")) return Unit.MEDIUM;
        else if (getSize().equalsIgnoreCase("Heavy")) return Unit.HEAVY;
