...
public class Player {
    ...
    protected PlayerFlags defaultPlayerFlags =
            new PlayerFlags(); // This is only going to be set for staff
    protected int mekToken =
            0; // A counter for how many meks a player is allowed to create in freebuild
