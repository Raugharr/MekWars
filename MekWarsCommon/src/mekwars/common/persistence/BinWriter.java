...
/**
 * BinWriter is a minimal textual based writer optimized to output as few characters as possible. To
 * do so, the structure information is silently ignored. So no error handling is provided and
 * invalid data structures will not be detectable by BinReader.
 *
...
public class BinWriter {
    ...
    /**
     * @see common.persistence.TreeWriter#write(common.persistence.MMNetSerializable,
     *     java.lang.String)
     *     <p>public void write(MMNetSerializable v, String name) { v.binOut(this); }
     *     <p>/**
     * @see common.persistence.TreeWriter#write(java.util.Collection, java.lang.String)
     *     <p>public void write(Collection<?> v, String name) { write(v.size(), null); for (Object
     *     it : v) write((MMNetSerializable)it,null); }
     */
